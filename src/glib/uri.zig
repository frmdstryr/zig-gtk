...
pub const Uri = extern struct {
    ...
    extern fn g_uri_is_valid(uri_string: [*c]const u8, flags: glib.UriFlags) bool;
    ...
    extern fn g_uri_parse(uri_string: [*c]const u8, flags: glib.UriFlags) ?*glib.Uri;
    pub const parse = g_uri_parse;

    extern fn g_uri_parse_params(params: [*c]const u8, length: i64, separators: [*c]const u8, flags: glib.UriParamsFlags) ?*glib.HashTable;
