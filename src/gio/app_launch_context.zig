...
pub const AppLaunchContext = extern struct {
    ...
    extern fn g_app_launch_context_get_display(self: *Self, info: *gio.AppInfo, files: *glib.List) [*c]const u8;
    ...
    pub inline fn gType() usize {
        return c.gio_app_launch_context_get_type();
    }
};
