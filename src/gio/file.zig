...
pub const File = extern struct {
    ...
    extern fn g_file_set_attribute(self: *Self, attribute: [*c]const u8, type: gio.FileAttributeType, value_p: ?*anyopaque, flags: gio.FileQueryInfoFlags, cancellable: ?*gio.Cancellable, err: **glib.Error) bool;
