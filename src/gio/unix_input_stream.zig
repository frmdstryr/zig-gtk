...
pub const UnixInputStream = extern struct {
    ...
    extern fn g_unix_input_stream_get_close_fd(self: *Self) bool;
    pub const getCloseFd = g_unix_input_stream_get_close_fd;

    extern fn g_unix_input_stream_get_fd(self: *Self) i32;
    ...
    extern fn g_unix_input_stream_set_close_fd(self: *Self, close_fd: bool) void;
