...
pub const UnixConnection = extern struct {
    ...
    extern fn g_unix_connection_receive_credentials(self: *Self, cancellable: ?*gio.Cancellable, err: ?*?*glib.Error) ?*gio.Credentials;
    pub inline fn receiveCredentials(self: *Self, cancellable: ?*gio.Cancellable, err: ?*?*glib.Error) !?*gio.Credentials {
        const tmp = g_unix_connection_receive_credentials(self, cancellable, err);
        return if (err != null and err.?.* != null) error.GlibError else tmp;
    }
    ...
    extern fn g_unix_connection_receive_credentials_finish(self: *Self, result: *gio.AsyncResult, err: ?*?*glib.Error) ?*gio.Credentials;
    pub inline fn receiveCredentialsFinish(self: *Self, result: *gio.AsyncResult, err: ?*?*glib.Error) !?*gio.Credentials {
        const tmp = g_unix_connection_receive_credentials_finish(self, result, err);
        return if (err != null and err.?.* != null) error.GlibError else tmp;
    }

    extern fn g_unix_connection_receive_fd(self: *Self, cancellable: ?*gio.Cancellable, err: ?*?*glib.Error) i32;
    pub inline fn receiveFd(self: *Self, cancellable: ?*gio.Cancellable, err: ?*?*glib.Error) !i32 {
        const tmp = g_unix_connection_receive_fd(self, cancellable, err);
        return if (err != null and err.?.* != null) error.GlibError else tmp;
    }
    ...
    extern fn g_unix_connection_send_credentials(self: *Self, cancellable: ?*gio.Cancellable, err: ?*?*glib.Error) bool;
    pub inline fn sendCredentials(self: *Self, cancellable: ?*gio.Cancellable, err: ?*?*glib.Error) !bool {
        const tmp = g_unix_connection_send_credentials(self, cancellable, err);
        return if (err != null and err.?.* != null) error.GlibError else tmp;
    }
    ...
    extern fn g_unix_connection_send_credentials_finish(self: *Self, result: *gio.AsyncResult, err: ?*?*glib.Error) bool;
    pub inline fn sendCredentialsFinish(self: *Self, result: *gio.AsyncResult, err: ?*?*glib.Error) !bool {
        const tmp = g_unix_connection_send_credentials_finish(self, result, err);
        return if (err != null and err.?.* != null) error.GlibError else tmp;
    }

    extern fn g_unix_connection_send_fd(self: *Self, fd: i32, cancellable: ?*gio.Cancellable, err: ?*?*glib.Error) bool;
    pub inline fn sendFd(self: *Self, fd: i32, cancellable: ?*gio.Cancellable, err: ?*?*glib.Error) !bool {
        const tmp = g_unix_connection_send_fd(self, fd, cancellable, err);
        return if (err != null and err.?.* != null) error.GlibError else tmp;
    }
