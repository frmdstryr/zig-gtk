...
pub const MenuAttributeIter = extern struct {
    ...
    extern fn g_menu_attribute_iter_get_name(self: *Self) [*c]const u8;
    pub const getName = g_menu_attribute_iter_get_name;

    extern fn g_menu_attribute_iter_get_next(self: *Self, out_name: [*c]const u8, value: *glib.Variant) bool;
    ...
    extern fn g_menu_attribute_iter_get_value(self: *Self) ?*glib.Variant;
    ...
    extern fn g_menu_attribute_iter_next(self: *Self) bool;
    ...
    pub inline fn gType() usize {
        return c.gio_menu_attribute_iter_get_type();
    }
};

test "gio.MenuAttributeIter" {
