...
pub const FileIcon = extern struct {
    const Self = @This();
    ...
    // Constructors
    extern fn g_file_icon_new(file: *gio.File) ?*Self;
    ...
    extern fn g_file_icon_get_file(self: *Self) ?*gio.File;
    ...
    pub inline fn gType() usize {
        return c.gio_file_icon_get_type();
    }
};
