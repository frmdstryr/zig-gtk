...
pub const SimpleAsyncResult = extern struct {
    ...
    // Constructors
    extern fn g_simple_async_result_new(source_object: ?*gobject.Object, callback: ?*const fn (source_object: ?*gobject.Object, res: *gio.AsyncResult, user_data: ?*anyopaque) callconv(.C) void, user_data: ?*anyopaque, source_tag: ?*anyopaque) ?*Self;
    pub const new = g_simple_async_result_new;

    extern fn g_simple_async_result_new_from_error(source_object: ?*gobject.Object, callback: ?*const fn (source_object: ?*gobject.Object, res: *gio.AsyncResult, user_data: ?*anyopaque) callconv(.C) void, user_data: ?*anyopaque, error_: *glib.Error) ?*Self;
    ...
    extern fn g_simple_async_result_is_valid(result: *gio.AsyncResult, source: ?*gobject.Object, source_tag: ?*anyopaque) bool;
    ...
    pub inline fn gType() usize {
        return c.gio_simple_async_result_get_type();
    }
};
