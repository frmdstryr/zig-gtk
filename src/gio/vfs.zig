...
pub const Vfs = extern struct {
    ...
    extern fn g_vfs_get_file_for_path(self: *Self, path: [*c]const u8) ?*gio.File;
    pub const getFileForPath = g_vfs_get_file_for_path;

    extern fn g_vfs_get_file_for_uri(self: *Self, uri: [*c]const u8) ?*gio.File;
    ...
    extern fn g_vfs_get_supported_uri_schemes(self: *Self) [*c][*c]const u8;
    pub const getSupportedUriSchemes = g_vfs_get_supported_uri_schemes;

    extern fn g_object_getv(self: *Self, n_properties: u32, names: [*c][*c]const u8, values: [*c]gobject.Value) void;
    pub const getv = g_object_getv;

    extern fn g_vfs_is_active(self: *Self) bool;
    ...
    extern fn g_vfs_parse_name(self: *Self, parse_name: [*c]const u8) ?*gio.File;
    ...
    extern fn g_vfs_register_uri_scheme(self: *Self, scheme: [*c]const u8, uri_func: ?*const fn (vfs: *gio.Vfs, identifier: [*c]const u8, user_data: ?*anyopaque) callconv(.C) *gio.File, uri_data: ?*anyopaque, uri_destroy: ?*const fn (data: ?*anyopaque) callconv(.C) void, parse_name_func: ?*const fn (vfs: *gio.Vfs, identifier: [*c]const u8, user_data: ?*anyopaque) callconv(.C) *gio.File, parse_name_data: ?*anyopaque, parse_name_destroy: ?*const fn (data: ?*anyopaque) callconv(.C) void) bool;
