...
pub const UnixOutputStream = extern struct {
    ...
    // Constructors
    extern fn g_unix_output_stream_new(fd: i32, close_fd: bool) ?*Self;
    ...
    extern fn g_unix_output_stream_get_close_fd(self: *Self) bool;
    pub const getCloseFd = g_unix_output_stream_get_close_fd;

    extern fn g_object_get_data(self: *Self, key: [*c]const u8) ?*anyopaque;
    pub const getData = g_object_get_data;

    extern fn g_unix_output_stream_get_fd(self: *Self) i32;
    ...
    extern fn g_unix_output_stream_set_close_fd(self: *Self, close_fd: bool) void;
    ...
    pub inline fn gType() usize {
        return c.gio_unix_output_stream_get_type();
    }
};
