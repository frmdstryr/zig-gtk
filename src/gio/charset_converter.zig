...
pub const CharsetConverter = extern struct {
    const Self = @This();
    ...
    // Constructors
    extern fn g_charset_converter_new(to_charset: [*c]const u8, from_charset: [*c]const u8) ?*Self;
    ...
    extern fn g_charset_converter_get_num_fallbacks(self: *Self) u32;
    ...
    extern fn g_charset_converter_get_use_fallback(self: *Self) bool;
    ...
    extern fn g_charset_converter_set_use_fallback(self: *Self, use_fallback: bool) void;
    ...
    pub inline fn gType() usize {
        return c.gio_charset_converter_get_type();
    }
};
