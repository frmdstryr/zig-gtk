...
// ObjectInfo(DebugControllerDBus)
...
pub const DebugControllerDBus = extern struct {
    ...
    extern fn g_debug_controller_dbus_stop(self: *Self) void;
    ...
    pub inline fn connectAuthorize(
        ...
        return c.g_signal_connect_data(self, "authorize", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectAuthorizeSwapped(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "authorize", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn gType() usize {
        return c.gio_debug_controller_d_bus_get_type();
    }
};

test "gio.DebugControllerDBus" {
