...
pub const MemoryInputStream = extern struct {
    ...
    extern fn g_memory_input_stream_new_from_data(data: [*c]u8, len: i64, destroy: ?*const fn (data: ?*anyopaque) callconv(.C) void) ?*Self;
    ...
    extern fn g_memory_input_stream_add_data(self: *Self, data: [*c]u8, len: i64, destroy: ?*const fn (data: ?*anyopaque) callconv(.C) void) void;
    ...
    pub inline fn gType() usize {
        return c.gio_memory_input_stream_get_type();
    }
};

test "gio.MemoryInputStream" {
