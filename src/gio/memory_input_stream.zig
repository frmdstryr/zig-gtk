...
pub const MemoryInputStream = extern struct {
    ...
    extern fn g_memory_input_stream_new_from_data(data: [*c][*c]const u8, len: i64, destroy: glib.DestroyNotify) ?*Self;
    ...
    extern fn g_memory_input_stream_add_data(self: *Self, data: [*c][*c]const u8, len: i64, destroy: glib.DestroyNotify) void;
    ...
    extern fn g_pollable_input_stream_read_nonblocking(self: *Self, buffer: [*c][*c]const u8, count: u64, cancellable: *gio.Cancellable) i64;
