...
pub const DBusActionGroup = extern struct {
    ...
    extern fn g_dbus_action_group_get(connection: *gio.DBusConnection, bus_name: [*c]const u8, object_path: [*c]const u8) ?*gio.DBusActionGroup;
    ...
    pub inline fn asRemoteActionGroup(self: *Self) *gio.RemoteActionGroup {
        return @ptrCast(self);
    }
    ...
    pub inline fn gType() usize {
        return c.gio_d_bus_action_group_get_type();
    }
};
