...
pub const TlsPassword = extern struct {
    ...
    extern fn g_tls_password_set_value_full(self: *Self, value: [*c]u8, length: i64, destroy: ?*const fn (data: ?*anyopaque) callconv(.C) void) void;
    ...
    pub inline fn gType() usize {
        return c.gio_tls_password_get_type();
    }
};
