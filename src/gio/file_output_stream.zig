...
pub const FileOutputStream = extern struct {
    ...
    extern fn g_file_output_stream_query_info(self: *Self, attributes: [*c]const u8, cancellable: ?*gio.Cancellable, err: ?*?*glib.Error) ?*gio.FileInfo;
    pub inline fn queryInfo(self: *Self, attributes: [*c]const u8, cancellable: ?*gio.Cancellable, err: ?*?*glib.Error) !?*gio.FileInfo {
        const tmp = g_file_output_stream_query_info(self, attributes, cancellable, err);
        return if (err != null and err.?.* != null) error.GlibError else tmp;
    }

    extern fn g_file_output_stream_query_info_async(self: *Self, attributes: [*c]const u8, io_priority: i32, cancellable: ?*gio.Cancellable, callback: ?*const fn (source_object: ?*gobject.Object, res: *gio.AsyncResult, user_data: ?*anyopaque) callconv(.C) void, user_data: ?*anyopaque) void;
    pub const queryInfoAsync = g_file_output_stream_query_info_async;

    extern fn g_file_output_stream_query_info_finish(self: *Self, result: *gio.AsyncResult, err: ?*?*glib.Error) ?*gio.FileInfo;
    pub inline fn queryInfoFinish(self: *Self, result: *gio.AsyncResult, err: ?*?*glib.Error) !?*gio.FileInfo {
        const tmp = g_file_output_stream_query_info_finish(self, result, err);
        return if (err != null and err.?.* != null) error.GlibError else tmp;
    }
    ...
    pub inline fn gType() usize {
        return c.gio_file_output_stream_get_type();
    }
};

test "gio.FileOutputStream" {
