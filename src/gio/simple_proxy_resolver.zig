...
// ObjectInfo(SimpleProxyResolver)
...
pub const SimpleProxyResolver = extern struct {
    ...
    extern fn g_simple_proxy_resolver_new(default_proxy: [*c]const u8, ignore_hosts: [*c][*c]const u8) ?*gio.ProxyResolver;
    ...
    pub inline fn gType() usize {
        return c.gio_simple_proxy_resolver_get_type();
    }
};
