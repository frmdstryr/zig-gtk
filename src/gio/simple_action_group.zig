...
pub const SimpleActionGroup = extern struct {
    ...
    // Methods
    extern fn g_simple_action_group_add_entries(self: *Self, entries: [*c]gio.ActionEntry, n_entries: i32, user_data: ?*anyopaque) void;
    ...
    pub inline fn gType() usize {
        return c.gio_simple_action_group_get_type();
    }
};
