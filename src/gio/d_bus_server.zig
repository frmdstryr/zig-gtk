...
pub const DBusServer = extern struct {
    ...
    extern fn g_dbus_server_get_client_address(self: *Self) [*c]const u8;
    pub const getClientAddress = g_dbus_server_get_client_address;

    extern fn g_object_get_data(self: *Self, key: [*c]const u8) ?*anyopaque;
    pub const getData = g_object_get_data;

    extern fn g_dbus_server_get_flags(self: *Self) gio.DBusServerFlags;
    pub const getFlags = g_dbus_server_get_flags;

    extern fn g_dbus_server_get_guid(self: *Self) [*c]const u8;
    ...
    extern fn g_dbus_server_is_active(self: *Self) bool;
    ...
    extern fn g_dbus_server_start(self: *Self) void;
    ...
    extern fn g_dbus_server_stop(self: *Self) void;
    ...
    pub inline fn connectNewConnection(
        ...
        return c.g_signal_connect_data(self, "new-connection", @ptrCast(callback), data, null, @intFromEnum(flags));
    }
    ...
    pub inline fn connectNewConnectionSwapped(
        ...
        return c.g_signal_connect_data(self, "new-connection", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn gType() usize {
        return c.gio_d_bus_server_get_type();
    }
};
