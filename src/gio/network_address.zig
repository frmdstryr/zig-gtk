...
pub const NetworkAddress = extern struct {
    ...
    // Constructors
    extern fn g_network_address_new(hostname: [*c]const u8, port: u16) ?*Self;
    pub const new = g_network_address_new;

    extern fn g_network_address_new_loopback(port: u16) ?*Self;
    ...
    extern fn g_network_address_get_hostname(self: *Self) [*c]const u8;
    pub const getHostname = g_network_address_get_hostname;

    extern fn g_network_address_get_port(self: *Self) u16;
    ...
    extern fn g_network_address_get_scheme(self: *Self) [*c]const u8;
    ...
    extern fn g_network_address_parse(host_and_port: [*c]const u8, default_port: u16) ?*gio.NetworkAddress;
    pub const parse = g_network_address_parse;

    extern fn g_network_address_parse_uri(uri: [*c]const u8, default_port: u16) ?*gio.NetworkAddress;
    ...
    pub inline fn gType() usize {
        return c.gio_network_address_get_type();
    }
};
