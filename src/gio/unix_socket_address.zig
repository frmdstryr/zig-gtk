...
pub const UnixSocketAddress = extern struct {
    ...
    extern fn g_unix_socket_address_new_abstract(path: [*c]i8, path_len: i32) ?*Self;
    ...
    extern fn g_unix_socket_address_abstract_names_supported() bool;
    ...
    pub inline fn gType() usize {
        return c.gio_unix_socket_address_get_type();
    }
};
