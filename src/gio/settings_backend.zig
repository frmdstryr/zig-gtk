...
pub const SettingsBackend = extern struct {
    ...
    extern fn g_settings_backend_changed(self: *Self, key: [*c]const u8, origin_tag: ?*anyopaque) void;
    pub const changed = g_settings_backend_changed;

    extern fn g_settings_backend_changed_tree(self: *Self, tree: *glib.Tree, origin_tag: ?*anyopaque) void;
    ...
    extern fn g_settings_backend_keys_changed(self: *Self, path: [*c]const u8, items: [*c][*c]const u8, origin_tag: ?*anyopaque) void;
    ...
    extern fn g_settings_backend_path_changed(self: *Self, path: [*c]const u8, origin_tag: ?*anyopaque) void;
    pub const pathChanged = g_settings_backend_path_changed;

    extern fn g_settings_backend_path_writable_changed(self: *Self, path: [*c]const u8) void;
    ...
    pub inline fn gType() usize {
        return c.gio_settings_backend_get_type();
    }
};
