...
pub const SimpleAction = extern struct {
    const Self = @This();
    ...
    // Constructors
    extern fn g_simple_action_new(name: [*c]const u8, parameter_type: ?*glib.VariantType) ?*Self;
    pub const new = g_simple_action_new;

    extern fn g_simple_action_new_stateful(name: [*c]const u8, parameter_type: ?*glib.VariantType, state: *glib.Variant) ?*Self;
    ...
    extern fn g_simple_action_set_enabled(self: *Self, enabled: bool) void;
    pub const setEnabled = g_simple_action_set_enabled;

    extern fn g_object_set_property(self: *Self, property_name: [*c]const u8, value: *gobject.Value) void;
    pub const setProperty = g_object_set_property;

    extern fn g_simple_action_set_state(self: *Self, value: *glib.Variant) void;
    pub const setState = g_simple_action_set_state;

    extern fn g_simple_action_set_state_hint(self: *Self, state_hint: ?*glib.Variant) void;
    ...
    pub inline fn connectChangeState(
        ...
        return c.g_signal_connect_data(self, "change-state", @ptrCast(callback), data, null, @intFromEnum(flags));
    }
    ...
    pub inline fn connectChangeStateSwapped(
        ...
        return c.g_signal_connect_data(self, "change-state", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn gType() usize {
        return c.gio_simple_action_get_type();
    }
};
