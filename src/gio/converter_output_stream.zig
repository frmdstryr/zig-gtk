...
// ObjectInfo(ConverterOutputStream)
...
pub const ConverterOutputStream = extern struct {
    ...
    extern fn g_converter_output_stream_get_converter(self: *Self) ?*gio.Converter;
    ...
    pub inline fn gType() usize {
        return c.gio_converter_output_stream_get_type();
    }
};
