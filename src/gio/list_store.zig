...
pub const ListStore = extern struct {
    ...
    // Constructors
    extern fn g_list_store_new(item_type: usize) ?*Self;
    ...
    // Methods
    extern fn g_list_store_append(self: *Self, item: *gobject.Object) void;
    ...
    extern fn g_list_store_insert(self: *Self, position: u32, item: *gobject.Object) void;
    pub const insert = g_list_store_insert;

    extern fn g_list_store_insert_sorted(self: *Self, item: *gobject.Object, compare_func: *const fn (a: ?*anyopaque, b: ?*anyopaque, user_data: ?*anyopaque) callconv(.C) i32, user_data: ?*anyopaque) u32;
    ...
    extern fn g_list_store_remove_all(self: *Self) void;
    ...
    extern fn g_list_store_sort(self: *Self, compare_func: *const fn (a: ?*anyopaque, b: ?*anyopaque, user_data: ?*anyopaque) callconv(.C) i32, user_data: ?*anyopaque) void;
    pub const sort = g_list_store_sort;

    extern fn g_list_store_splice(self: *Self, position: u32, n_removals: u32, additions: [*c]gobject.Object, n_additions: u32) void;
    ...
    pub inline fn gType() usize {
        return c.gio_list_store_get_type();
    }
};
