...
pub const MemoryOutputStream = extern struct {
    ...
    extern fn g_memory_output_stream_get_data(self: *Self) ?*anyopaque;
    pub const getData = g_memory_output_stream_get_data;

    extern fn g_memory_output_stream_get_data_size(self: *Self) u64;
    ...
    extern fn g_memory_output_stream_steal_as_bytes(self: *Self) ?*glib.Bytes;
    pub const stealAsBytes = g_memory_output_stream_steal_as_bytes;

    extern fn g_memory_output_stream_steal_data(self: *Self) ?*anyopaque;
    ...
    pub inline fn gType() usize {
        return c.gio_memory_output_stream_get_type();
    }
};
