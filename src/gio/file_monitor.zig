...
pub const FileMonitor = extern struct {
    ...
    extern fn g_file_monitor_cancel(self: *Self) bool;
    pub const cancel = g_file_monitor_cancel;

    extern fn g_file_monitor_emit_event(self: *Self, child: *gio.File, other_file: *gio.File, event_type: gio.FileMonitorEvent) void;
    ...
    extern fn g_file_monitor_is_cancelled(self: *Self) bool;
    ...
    extern fn g_file_monitor_set_rate_limit(self: *Self, limit_msecs: i32) void;
    ...
    pub inline fn gType() usize {
        return c.gio_file_monitor_get_type();
    }
};
