...
// ObjectInfo(EventControllerFocus)
...
pub const EventControllerFocus = extern struct {
    const Self = @This();
    ...
    // Constructors
    extern fn gtk_event_controller_focus_new() ?*Self;
    ...
    extern fn gtk_event_controller_focus_contains_focus(self: *Self) bool;
    ...
    extern fn gtk_event_controller_focus_is_focus(self: *Self) bool;
