...
pub const FontChooserDialog = extern struct {
    ...
    // Constructors
    extern fn gtk_font_chooser_dialog_new(title: [*c]const u8, parent: ?*gtk.Window) ?*Self;
    ...
    pub inline fn asFontChooser(self: *Self) *gtk.FontChooser {
        return @ptrCast(self);
    }
