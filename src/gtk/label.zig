...
pub const Label = extern struct {
    ...
    // Constructors
    extern fn gtk_label_new(str: [*c]const u8) ?*Self;
    pub const new = gtk_label_new;

    extern fn gtk_label_new_with_mnemonic(str: [*c]const u8) ?*Self;
    ...
    extern fn gtk_label_get_current_uri(self: *Self) [*c]const u8;
    ...
    extern fn gtk_label_get_ellipsize(self: *Self) pango.EllipsizeMode;
    pub const getEllipsize = gtk_label_get_ellipsize;

    extern fn gtk_label_get_extra_menu(self: *Self) ?*gio.MenuModel;
    pub const getExtraMenu = gtk_label_get_extra_menu;
    ...
    extern fn gtk_label_get_justify(self: *Self) gtk.Justification;
    pub const getJustify = gtk_label_get_justify;

    extern fn gtk_label_get_label(self: *Self) [*c]const u8;
    ...
    extern fn gtk_label_get_layout(self: *Self) ?*pango.Layout;
    ...
    extern fn gtk_label_get_layout_offsets(self: *Self, x: *i32, y: *i32) void;
    pub const getLayoutOffsets = gtk_label_get_layout_offsets;

    extern fn gtk_label_get_lines(self: *Self) i32;
    ...
    extern fn gtk_label_get_max_width_chars(self: *Self) i32;
    pub const getMaxWidthChars = gtk_label_get_max_width_chars;

    extern fn gtk_label_get_mnemonic_keyval(self: *Self) u32;
    pub const getMnemonicKeyval = gtk_label_get_mnemonic_keyval;

    extern fn gtk_label_get_mnemonic_widget(self: *Self) ?*gtk.Widget;
    ...
    extern fn gtk_label_get_natural_wrap_mode(self: *Self) gtk.NaturalWrapMode;
    pub const getNaturalWrapMode = gtk_label_get_natural_wrap_mode;
    ...
    extern fn gtk_label_get_selectable(self: *Self) bool;
    pub const getSelectable = gtk_label_get_selectable;

    extern fn gtk_label_get_selection_bounds(self: *Self, start: *i32, end: *i32) bool;
    ...
    extern fn gtk_label_get_single_line_mode(self: *Self) bool;
    ...
    extern fn gtk_label_get_text(self: *Self) [*c]const u8;
    ...
    extern fn gtk_label_get_use_markup(self: *Self) bool;
    pub const getUseMarkup = gtk_label_get_use_markup;

    extern fn gtk_label_get_use_underline(self: *Self) bool;
    ...
    extern fn gtk_label_get_width_chars(self: *Self) i32;
    pub const getWidthChars = gtk_label_get_width_chars;

    extern fn gtk_label_get_wrap(self: *Self) bool;
    pub const getWrap = gtk_label_get_wrap;

    extern fn gtk_label_get_wrap_mode(self: *Self) pango.WrapMode;
    pub const getWrapMode = gtk_label_get_wrap_mode;

    extern fn gtk_label_get_xalign(self: *Self) f32;
    pub const getXalign = gtk_label_get_xalign;

    extern fn gtk_label_get_yalign(self: *Self) f32;
    ...
    extern fn gtk_label_select_region(self: *Self, start_offset: i32, end_offset: i32) void;
    pub const selectRegion = gtk_label_select_region;

    extern fn gtk_label_set_attributes(self: *Self, attrs: ?*pango.AttrList) void;
    ...
    extern fn gtk_label_set_ellipsize(self: *Self, mode: pango.EllipsizeMode) void;
    pub const setEllipsize = gtk_label_set_ellipsize;

    extern fn gtk_label_set_extra_menu(self: *Self, model: ?*gio.MenuModel) void;
    pub const setExtraMenu = gtk_label_set_extra_menu;
    ...
    extern fn gtk_label_set_justify(self: *Self, jtype: gtk.Justification) void;
    pub const setJustify = gtk_label_set_justify;

    extern fn gtk_label_set_label(self: *Self, str: [*c]const u8) void;
    ...
    extern fn gtk_label_set_lines(self: *Self, lines: i32) void;
    ...
    extern fn gtk_label_set_markup(self: *Self, str: [*c]const u8) void;
    pub const setMarkup = gtk_label_set_markup;

    extern fn gtk_label_set_markup_with_mnemonic(self: *Self, str: [*c]const u8) void;
    pub const setMarkupWithMnemonic = gtk_label_set_markup_with_mnemonic;

    extern fn gtk_label_set_max_width_chars(self: *Self, n_chars: i32) void;
    pub const setMaxWidthChars = gtk_label_set_max_width_chars;

    extern fn gtk_label_set_mnemonic_widget(self: *Self, widget: ?*gtk.Widget) void;
    ...
    extern fn gtk_label_set_natural_wrap_mode(self: *Self, wrap_mode: gtk.NaturalWrapMode) void;
    pub const setNaturalWrapMode = gtk_label_set_natural_wrap_mode;
    ...
    extern fn gtk_label_set_selectable(self: *Self, setting: bool) void;
    ...
    extern fn gtk_label_set_single_line_mode(self: *Self, single_line_mode: bool) void;
    ...
    extern fn gtk_label_set_text_with_mnemonic(self: *Self, str: [*c]const u8) void;
    ...
    extern fn gtk_label_set_use_markup(self: *Self, setting: bool) void;
    pub const setUseMarkup = gtk_label_set_use_markup;

    extern fn gtk_label_set_use_underline(self: *Self, setting: bool) void;
    ...
    extern fn gtk_label_set_width_chars(self: *Self, n_chars: i32) void;
    pub const setWidthChars = gtk_label_set_width_chars;

    extern fn gtk_label_set_wrap(self: *Self, wrap: bool) void;
    pub const setWrap = gtk_label_set_wrap;

    extern fn gtk_label_set_wrap_mode(self: *Self, wrap_mode: pango.WrapMode) void;
    pub const setWrapMode = gtk_label_set_wrap_mode;

    extern fn gtk_label_set_xalign(self: *Self, xalign: f32) void;
    pub const setXalign = gtk_label_set_xalign;

    extern fn gtk_label_set_yalign(self: *Self, yalign: f32) void;
    ...
    // Signals
    pub inline fn connectActivateCurrentLink(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "activate-current-link", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectActivateCurrentLinkSwapped(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "activate-current-link", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn connectActivateLink(
        ...
        return c.g_signal_connect_data(self, "activate-link", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectActivateLinkSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, uri: [*c]const u8) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "activate-link", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
