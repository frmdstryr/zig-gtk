...
pub const Scrollbar = extern struct {
    ...
    // Constructors
    extern fn gtk_scrollbar_new(orientation: gtk.Orientation, adjustment: ?*gtk.Adjustment) ?*Self;
    ...
    extern fn gtk_scrollbar_get_adjustment(self: *Self) ?*gtk.Adjustment;
    pub const getAdjustment = gtk_scrollbar_get_adjustment;
    ...
    extern fn gtk_scrollbar_set_adjustment(self: *Self, adjustment: ?*gtk.Adjustment) void;
    pub const setAdjustment = gtk_scrollbar_set_adjustment;
