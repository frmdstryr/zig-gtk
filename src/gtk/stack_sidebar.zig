...
pub const StackSidebar = extern struct {
    ...
    // Constructors
    extern fn gtk_stack_sidebar_new() ?*Self;
    ...
    extern fn gtk_stack_sidebar_get_stack(self: *Self) ?*gtk.Stack;
    ...
    extern fn gtk_stack_sidebar_set_stack(self: *Self, stack: *gtk.Stack) void;
