...
pub const GLArea = extern struct {
    ...
    // Constructors
    extern fn gtk_gl_area_new() ?*Self;
    ...
    extern fn gtk_gl_area_attach_buffers(self: *Self) void;
    ...
    extern fn gtk_gl_area_get_has_depth_buffer(self: *Self) bool;
    pub const getHasDepthBuffer = gtk_gl_area_get_has_depth_buffer;

    extern fn gtk_gl_area_get_has_stencil_buffer(self: *Self) bool;
    ...
    extern fn gtk_gl_area_get_required_version(self: *Self, major: *i32, minor: *i32) void;
    ...
    extern fn gtk_gl_area_get_use_es(self: *Self) bool;
    ...
    extern fn gtk_gl_area_make_current(self: *Self) void;
    ...
    extern fn gtk_gl_area_queue_render(self: *Self) void;
    ...
    extern fn gtk_gl_area_set_has_depth_buffer(self: *Self, has_depth_buffer: bool) void;
    pub const setHasDepthBuffer = gtk_gl_area_set_has_depth_buffer;

    extern fn gtk_gl_area_set_has_stencil_buffer(self: *Self, has_stencil_buffer: bool) void;
    ...
    extern fn gtk_gl_area_set_required_version(self: *Self, major: i32, minor: i32) void;
    ...
    extern fn gtk_gl_area_set_use_es(self: *Self, use_es: bool) void;
    ...
    // Signals
    pub inline fn connectCreateContext(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, data: ?*T) callconv(.C) gdk.GLContext,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "create-context", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectCreateContextSwapped(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "create-context", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectRender(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, context: *gdk.GLContext, data: ?*T) callconv(.C) bool,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
    ...
    pub inline fn connectRenderSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, context: *gdk.GLContext) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
    ...
    pub inline fn connectResize(
        ...
        return c.g_signal_connect_data(self, "resize", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectResizeSwapped(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "resize", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
