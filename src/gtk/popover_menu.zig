...
pub const PopoverMenu = extern struct {
    ...
    pub const newFromModelFull = gtk_popover_menu_new_from_model_full;
    ...
    extern fn gtk_popover_menu_add_child(self: *Self, child: *gtk.Widget, id: [*c]const u8) bool;
    pub const addChild = gtk_popover_menu_add_child;
    ...
    extern fn gtk_popover_menu_get_menu_model(self: *Self) ?*gio.MenuModel;
    pub const getMenuModel = gtk_popover_menu_get_menu_model;
    ...
    extern fn gtk_popover_menu_remove_child(self: *Self, child: *gtk.Widget) bool;
    pub const removeChild = gtk_popover_menu_remove_child;
