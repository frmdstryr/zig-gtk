...
pub const ListStore = extern struct {
    ...
    // Constructors
    extern fn gtk_list_store_newv(n_columns: i32, types: [*c][*c]const u8) ?*Self;
    ...
    extern fn gtk_list_store_insert_with_valuesv(self: *Self, iter: gtk.TreeIter, position: i32, columns: [*c][*c]const u8, values: [*c][*c]const u8, n_values: i32) void;
    ...
    extern fn gtk_list_store_reorder(self: *Self, new_order: [*c][*c]const u8) void;
    ...
    extern fn gtk_list_store_set_column_types(self: *Self, n_columns: i32, types: [*c][*c]const u8) void;
