...
pub const ListItem = extern struct {
    ...
    extern fn gtk_list_item_get_child(self: *Self) ?*gtk.Widget;
    pub const getChild = gtk_list_item_get_child;
    ...
    extern fn gtk_list_item_get_position(self: *Self) u32;
    pub const getPosition = gtk_list_item_get_position;
    ...
    extern fn gtk_list_item_get_selected(self: *Self) bool;
    pub const getSelected = gtk_list_item_get_selected;
