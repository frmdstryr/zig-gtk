...
pub const WindowGroup = extern struct {
    ...
    // Constructors
    extern fn gtk_window_group_new() ?*Self;
    ...
    // Methods
    extern fn gtk_window_group_add_window(self: *Self, window: *gtk.Window) void;
    ...
    extern fn gtk_window_group_list_windows(self: *Self) ?*glib.List;
    ...
    extern fn gtk_window_group_remove_window(self: *Self, window: *gtk.Window) void;
