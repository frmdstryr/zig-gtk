...
pub const GestureStylus = extern struct {
    ...
    pub inline fn connectDown(
        ...
        return c.g_signal_connect_data(self, "down", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectDownSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, x: f64, y: f64) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "down", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn connectMotion(
        ...
        return c.g_signal_connect_data(self, "motion", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectMotionSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, x: f64, y: f64) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "motion", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectProximity(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, x: f64, y: f64, data: ?*T) callconv(.C) void,
        data: ?*T,
        ...
        return c.g_signal_connect_data(self, "proximity", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectProximitySwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, x: f64, y: f64) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "proximity", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectUp(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, x: f64, y: f64, data: ?*T) callconv(.C) void,
        data: ?*T,
        ...
        return c.g_signal_connect_data(self, "up", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectUpSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, x: f64, y: f64) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "up", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
