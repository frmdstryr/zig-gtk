...
pub const MessageDialog = extern struct {
    ...
    extern fn gtk_message_dialog_get_message_area(self: *Self) ?*gtk.Widget;
    ...
    extern fn gtk_message_dialog_set_markup(self: *Self, str: [*c]const u8) void;
    ...
    pub const Properties = enum(u8) {
        ...
        default_width = 13,
        deletable = 14,
        destroy_with_parent = 15,
        display = 16,
        focus_visible = 17,
        focus_widget = 18,
        fullscreened = 19,
        handle_menubar_accel = 20,
        hide_on_close = 21,
        icon_name = 22,
        is_active = 23,
        maximized = 24,
        mnemonics_visible = 25,
        modal = 26,
        resizable = 27,
        startup_id = 28,
        title = 29,
