...
pub const ProgressBar = extern struct {
    ...
    // Constructors
    extern fn gtk_progress_bar_new() ?*Self;
    ...
    extern fn gtk_progress_bar_get_ellipsize(self: *Self) pango.EllipsizeMode;
    ...
    extern fn gtk_progress_bar_get_fraction(self: *Self) f64;
    ...
    extern fn gtk_progress_bar_get_inverted(self: *Self) bool;
    ...
    extern fn gtk_progress_bar_get_pulse_step(self: *Self) f64;
    ...
    extern fn gtk_progress_bar_get_show_text(self: *Self) bool;
    ...
    extern fn gtk_progress_bar_get_text(self: *Self) [*c]const u8;
    ...
    extern fn gtk_progress_bar_pulse(self: *Self) void;
    ...
    extern fn gtk_progress_bar_set_ellipsize(self: *Self, mode: pango.EllipsizeMode) void;
    ...
    extern fn gtk_progress_bar_set_fraction(self: *Self, fraction: f64) void;
    ...
    extern fn gtk_progress_bar_set_inverted(self: *Self, inverted: bool) void;
    ...
    extern fn gtk_progress_bar_set_pulse_step(self: *Self, fraction: f64) void;
    ...
    extern fn gtk_progress_bar_set_show_text(self: *Self, show_text: bool) void;
    ...
    extern fn gtk_progress_bar_set_text(self: *Self, text: [*c]const u8) void;
