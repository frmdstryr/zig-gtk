...
pub const Overlay = extern struct {
    ...
    // Constructors
    extern fn gtk_overlay_new() ?*Self;
    ...
    extern fn gtk_overlay_add_overlay(self: *Self, widget: *gtk.Widget) void;
    ...
    extern fn gtk_overlay_get_child(self: *Self) ?*gtk.Widget;
    pub const getChild = gtk_overlay_get_child;

    extern fn gtk_widget_get_child_visible(self: *Self) bool;
    pub const getChildVisible = gtk_widget_get_child_visible;

    extern fn gtk_overlay_get_clip_overlay(self: *Self, widget: *gtk.Widget) bool;
    pub const getClipOverlay = gtk_overlay_get_clip_overlay;
    ...
    extern fn gtk_overlay_get_measure_overlay(self: *Self, widget: *gtk.Widget) bool;
    pub const getMeasureOverlay = gtk_overlay_get_measure_overlay;
    ...
    extern fn gtk_overlay_remove_overlay(self: *Self, widget: *gtk.Widget) void;
    pub const removeOverlay = gtk_overlay_remove_overlay;
    ...
    extern fn gtk_overlay_set_child(self: *Self, child: ?*gtk.Widget) void;
    pub const setChild = gtk_overlay_set_child;
    ...
    extern fn gtk_overlay_set_clip_overlay(self: *Self, widget: *gtk.Widget, clip_overlay: bool) void;
    pub const setClipOverlay = gtk_overlay_set_clip_overlay;
    ...
    extern fn gtk_overlay_set_measure_overlay(self: *Self, widget: *gtk.Widget, measure_: bool) void;
    pub const setMeasureOverlay = gtk_overlay_set_measure_overlay;
    ...
    // Signals
    pub inline fn connectGetChildPosition(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, widget: *gtk.Widget, allocation: *gdk.Rectangle, data: ?*T) callconv(.C) bool,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "get-child-position", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectGetChildPositionSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, widget: *gtk.Widget, allocation: *gdk.Rectangle) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "get-child-position", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
