...
pub const HeaderBar = extern struct {
    ...
    // Constructors
    extern fn gtk_header_bar_new() ?*Self;
    ...
    extern fn gtk_header_bar_get_decoration_layout(self: *Self) [*c]const u8;
    ...
    extern fn gtk_header_bar_get_show_title_buttons(self: *Self) bool;
    ...
    extern fn gtk_header_bar_get_title_widget(self: *Self) ?*gtk.Widget;
    pub const getTitleWidget = gtk_header_bar_get_title_widget;
    ...
    extern fn gtk_header_bar_pack_end(self: *Self, child: *gtk.Widget) void;
    pub const packEnd = gtk_header_bar_pack_end;

    extern fn gtk_header_bar_pack_start(self: *Self, child: *gtk.Widget) void;
    ...
    extern fn gtk_header_bar_remove(self: *Self, child: *gtk.Widget) void;
    pub const remove = gtk_header_bar_remove;
    ...
    extern fn gtk_header_bar_set_decoration_layout(self: *Self, layout: [*c]const u8) void;
    ...
    extern fn gtk_header_bar_set_show_title_buttons(self: *Self, setting: bool) void;
    pub const setShowTitleButtons = gtk_header_bar_set_show_title_buttons;
    ...
    extern fn gtk_header_bar_set_title_widget(self: *Self, title_widget: ?*gtk.Widget) void;
    pub const setTitleWidget = gtk_header_bar_set_title_widget;
