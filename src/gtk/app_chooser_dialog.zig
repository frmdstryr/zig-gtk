...
pub const AppChooserDialog = extern struct {
    ...
    // Constructors
    extern fn gtk_app_chooser_dialog_new(parent: ?*gtk.Window, flags: gtk.DialogFlags, file: *gio.File) ?*Self;
    pub const new = gtk_app_chooser_dialog_new;

    extern fn gtk_app_chooser_dialog_new_for_content_type(parent: ?*gtk.Window, flags: gtk.DialogFlags, content_type: [*c]const u8) ?*Self;
    ...
    extern fn gtk_app_chooser_dialog_get_heading(self: *Self) [*c]const u8;
    ...
    extern fn gtk_app_chooser_dialog_get_widget(self: *Self) ?*gtk.Widget;
    ...
    extern fn gtk_app_chooser_dialog_set_heading(self: *Self, heading: [*c]const u8) void;
    ...
    pub const Properties = enum(u8) {
        ...
        default_width = 8,
        deletable = 9,
        destroy_with_parent = 10,
        display = 11,
        focus_visible = 12,
        focus_widget = 13,
        fullscreened = 14,
        handle_menubar_accel = 15,
        hide_on_close = 16,
        icon_name = 17,
        is_active = 18,
        maximized = 19,
        mnemonics_visible = 20,
        modal = 21,
        resizable = 22,
        startup_id = 23,
        title = 24,
    ...
    pub inline fn asAppChooser(self: *Self) *gtk.AppChooser {
        return @ptrCast(self);
    }
