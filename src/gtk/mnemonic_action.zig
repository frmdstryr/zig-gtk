...
pub const MnemonicAction = extern struct {
    const Self = @This();
    ...
    extern fn gtk_mnemonic_action_get() ?*gtk.MnemonicAction;
    pub const get = gtk_mnemonic_action_get;
    ...
    pub inline fn gType() usize {
        return c.gtk_mnemonic_action_get_type();
    }
};
