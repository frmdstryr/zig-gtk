...
pub const TreeExpander = extern struct {
    const Self = @This();
    ...
    // Constructors
    extern fn gtk_tree_expander_new() ?*Self;
    pub const new = gtk_tree_expander_new;
    ...
    extern fn gtk_tree_expander_get_child(self: *Self) ?*gtk.Widget;
    pub const getChild = gtk_tree_expander_get_child;
    ...
    extern fn gtk_tree_expander_get_item(self: *Self) ?*gobject.Object;
    pub const getItem = gtk_tree_expander_get_item;
    ...
    extern fn gtk_tree_expander_get_list_row(self: *Self) ?*gtk.TreeListRow;
    pub const getListRow = gtk_tree_expander_get_list_row;
    ...
    extern fn gtk_tree_expander_set_child(self: *Self, child: ?*gtk.Widget) void;
    pub const setChild = gtk_tree_expander_set_child;
    ...
    extern fn gtk_tree_expander_set_list_row(self: *Self, list_row: ?*gtk.TreeListRow) void;
    pub const setListRow = gtk_tree_expander_set_list_row;
