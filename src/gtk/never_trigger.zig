...
pub const NeverTrigger = extern struct {
    const Self = @This();
    ...
    extern fn gtk_never_trigger_get() ?*gtk.NeverTrigger;
    pub const get = gtk_never_trigger_get;
    ...
    pub inline fn gType() usize {
        return c.gtk_never_trigger_get_type();
    }
};
