...
pub const Fixed = extern struct {
    ...
    extern fn gtk_fixed_get_child_position(self: *Self, widget: *gtk.Widget, x: *f64, y: *f64) void;
    pub const getChildPosition = gtk_fixed_get_child_position;

    extern fn gtk_fixed_get_child_transform(self: *Self, widget: *gtk.Widget) ?*gsk.Transform;
    ...
    extern fn gtk_fixed_move(self: *Self, widget: *gtk.Widget, x: f64, y: f64) void;
    ...
    extern fn gtk_fixed_put(self: *Self, widget: *gtk.Widget, x: f64, y: f64) void;
    ...
    extern fn gtk_fixed_remove(self: *Self, widget: *gtk.Widget) void;
    ...
    extern fn gtk_fixed_set_child_transform(self: *Self, widget: *gtk.Widget, transform: ?*gsk.Transform) void;
