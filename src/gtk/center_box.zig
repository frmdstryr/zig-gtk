...
pub const CenterBox = extern struct {
    const Self = @This();
    ...
    // Constructors
    extern fn gtk_center_box_new() ?*Self;
    ...
    extern fn gtk_center_box_get_center_widget(self: *Self) ?*gtk.Widget;
    ...
    extern fn gtk_center_box_get_end_widget(self: *Self) ?*gtk.Widget;
    ...
    extern fn gtk_center_box_get_start_widget(self: *Self) ?*gtk.Widget;
    ...
    extern fn gtk_center_box_set_baseline_position(self: *Self, position: gtk.BaselinePosition) void;
    ...
    extern fn gtk_center_box_set_center_widget(self: *Self, child: ?*gtk.Widget) void;
    ...
    extern fn gtk_center_box_set_end_widget(self: *Self, child: ?*gtk.Widget) void;
    ...
    extern fn gtk_center_box_set_start_widget(self: *Self, child: ?*gtk.Widget) void;
