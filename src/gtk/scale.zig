...
pub const Scale = extern struct {
    ...
    // Constructors
    extern fn gtk_scale_new(orientation: gtk.Orientation, adjustment: ?*gtk.Adjustment) ?*Self;
    pub const new = gtk_scale_new;

    extern fn gtk_scale_new_with_range(orientation: gtk.Orientation, min: f64, max: f64, step: f64) ?*Self;
    ...
    extern fn gtk_scale_add_mark(self: *Self, value: f64, position: gtk.PositionType, markup: [*c]const u8) void;
    ...
    extern fn gtk_scale_clear_marks(self: *Self) void;
    ...
    extern fn gtk_scale_get_digits(self: *Self) i32;
    ...
    extern fn gtk_scale_get_draw_value(self: *Self) bool;
    ...
    extern fn gtk_scale_get_has_origin(self: *Self) bool;
    ...
    extern fn gtk_scale_get_layout(self: *Self) ?*pango.Layout;
    ...
    extern fn gtk_scale_get_layout_offsets(self: *Self, x: *i32, y: *i32) void;
    ...
    extern fn gtk_scale_get_value_pos(self: *Self) gtk.PositionType;
    ...
    extern fn gtk_scale_set_digits(self: *Self, digits: i32) void;
    ...
    extern fn gtk_scale_set_draw_value(self: *Self, draw_value: bool) void;
    ...
    extern fn gtk_scale_set_format_value_func(self: *Self, func: ?*const fn (scale: *gtk.Scale, value: f64, user_data: ?*anyopaque) callconv(.C) [*c]const u8, user_data: ?*anyopaque, destroy_notify: ?*const fn (data: ?*anyopaque) callconv(.C) void) void;
    pub const setFormatValueFunc = gtk_scale_set_format_value_func;

    extern fn gtk_widget_set_halign(self: *Self, align_: gtk.Align) void;
    pub const setHalign = gtk_widget_set_halign;

    extern fn gtk_scale_set_has_origin(self: *Self, has_origin: bool) void;
    ...
    extern fn gtk_scale_set_value_pos(self: *Self, pos: gtk.PositionType) void;
    ...
    // Signals
    pub inline fn connectAdjustBounds(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, value: f64, data: ?*T) callconv(.C) void,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "adjust-bounds", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectAdjustBoundsSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, value: f64) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "adjust-bounds", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectChangeValue(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, scroll: gtk.ScrollType, value: f64, data: ?*T) callconv(.C) bool,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "change-value", @ptrCast(callback), data, null, @intFromEnum(flags));
    }
    ...
    pub inline fn connectChangeValueSwapped(
        ...
        return c.g_signal_connect_data(self, "change-value", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn connectMoveSlider(
        ...
        return c.g_signal_connect_data(self, "move-slider", @ptrCast(callback), data, null, @intFromEnum(flags));
    }
    ...
    pub inline fn connectMoveSliderSwapped(
        ...
        return c.g_signal_connect_data(self, "move-slider", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn asRange(self: *Self) *gtk.Range {
        return @ptrCast(self);
    }
