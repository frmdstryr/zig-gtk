...
pub const ApplicationWindow = extern struct {
    ...
    extern fn gtk_application_window_get_help_overlay(self: *Self) ?*gtk.ShortcutsWindow;
    ...
    extern fn gtk_application_window_get_id(self: *Self) u32;
    ...
    extern fn gtk_application_window_get_show_menubar(self: *Self) bool;
    ...
    extern fn gtk_application_window_set_show_menubar(self: *Self, show_menubar: bool) void;
