...
pub const Stack = extern struct {
    ...
    extern fn gtk_stack_add_child(self: *Self, child: *gtk.Widget) ?*gtk.StackPage;
    pub const addChild = gtk_stack_add_child;
    ...
    extern fn gtk_stack_get_child_by_name(self: *Self, name: [*c]const u8) ?*gtk.Widget;
    ...
    extern fn gtk_stack_get_hhomogeneous(self: *Self) bool;
    pub const getHhomogeneous = gtk_stack_get_hhomogeneous;

    extern fn gtk_stack_get_interpolate_size(self: *Self) bool;
    ...
    extern fn gtk_stack_get_page(self: *Self, child: *gtk.Widget) ?*gtk.StackPage;
    pub const getPage = gtk_stack_get_page;

    extern fn gtk_stack_get_pages(self: *Self) ?*gtk.SelectionModel;
    pub const getPages = gtk_stack_get_pages;
    ...
    extern fn gtk_stack_get_transition_duration(self: *Self) u32;
    pub const getTransitionDuration = gtk_stack_get_transition_duration;

    extern fn gtk_stack_get_transition_running(self: *Self) bool;
    pub const getTransitionRunning = gtk_stack_get_transition_running;

    extern fn gtk_stack_get_transition_type(self: *Self) gtk.StackTransitionType;
    ...
    extern fn gtk_stack_get_vhomogeneous(self: *Self) bool;
    ...
    extern fn gtk_stack_get_visible_child(self: *Self) ?*gtk.Widget;
    pub const getVisibleChild = gtk_stack_get_visible_child;

    extern fn gtk_stack_get_visible_child_name(self: *Self) [*c]const u8;
    ...
    extern fn gtk_stack_remove(self: *Self, child: *gtk.Widget) void;
    pub const remove = gtk_stack_remove;
    ...
    extern fn gtk_stack_set_hhomogeneous(self: *Self, hhomogeneous: bool) void;
    pub const setHhomogeneous = gtk_stack_set_hhomogeneous;

    extern fn gtk_stack_set_interpolate_size(self: *Self, interpolate_size: bool) void;
    ...
    extern fn gtk_stack_set_transition_duration(self: *Self, duration: u32) void;
    pub const setTransitionDuration = gtk_stack_set_transition_duration;

    extern fn gtk_stack_set_transition_type(self: *Self, transition: gtk.StackTransitionType) void;
    ...
    extern fn gtk_stack_set_vhomogeneous(self: *Self, vhomogeneous: bool) void;
    ...
    extern fn gtk_stack_set_visible_child(self: *Self, child: *gtk.Widget) void;
    pub const setVisibleChild = gtk_stack_set_visible_child;

    extern fn gtk_stack_set_visible_child_full(self: *Self, name: [*c]const u8, transition: gtk.StackTransitionType) void;
    pub const setVisibleChildFull = gtk_stack_set_visible_child_full;

    extern fn gtk_stack_set_visible_child_name(self: *Self, name: [*c]const u8) void;
