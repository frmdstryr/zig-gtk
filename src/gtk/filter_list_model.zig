...
pub const FilterListModel = extern struct {
    const Self = @This();
    ...
    // Constructors
    extern fn gtk_filter_list_model_new(model: ?*gio.ListModel, filter: ?*gtk.Filter) ?*Self;
    ...
    extern fn gtk_filter_list_model_get_filter(self: *Self) ?*gtk.Filter;
    pub const getFilter = gtk_filter_list_model_get_filter;

    extern fn gtk_filter_list_model_get_incremental(self: *Self) bool;
    pub const getIncremental = gtk_filter_list_model_get_incremental;

    extern fn gtk_filter_list_model_get_model(self: *Self) ?*gio.ListModel;
    pub const getModel = gtk_filter_list_model_get_model;

    extern fn gtk_filter_list_model_get_pending(self: *Self) u32;
    ...
    extern fn gtk_filter_list_model_set_filter(self: *Self, filter: ?*gtk.Filter) void;
    pub const setFilter = gtk_filter_list_model_set_filter;

    extern fn gtk_filter_list_model_set_incremental(self: *Self, incremental: bool) void;
    pub const setIncremental = gtk_filter_list_model_set_incremental;

    extern fn gtk_filter_list_model_set_model(self: *Self, model: ?*gio.ListModel) void;
