...
pub const AppChooserWidget = extern struct {
    ...
    // Constructors
    extern fn gtk_app_chooser_widget_new(content_type: [*c]const u8) ?*Self;
    ...
    extern fn gtk_app_chooser_widget_get_default_text(self: *Self) [*c]const u8;
    ...
    extern fn gtk_app_chooser_widget_get_show_all(self: *Self) bool;
    pub const getShowAll = gtk_app_chooser_widget_get_show_all;

    extern fn gtk_app_chooser_widget_get_show_default(self: *Self) bool;
    pub const getShowDefault = gtk_app_chooser_widget_get_show_default;

    extern fn gtk_app_chooser_widget_get_show_fallback(self: *Self) bool;
    pub const getShowFallback = gtk_app_chooser_widget_get_show_fallback;

    extern fn gtk_app_chooser_widget_get_show_other(self: *Self) bool;
    pub const getShowOther = gtk_app_chooser_widget_get_show_other;

    extern fn gtk_app_chooser_widget_get_show_recommended(self: *Self) bool;
    ...
    extern fn gtk_app_chooser_widget_set_default_text(self: *Self, text: [*c]const u8) void;
    ...
    extern fn gtk_app_chooser_widget_set_show_all(self: *Self, setting: bool) void;
    pub const setShowAll = gtk_app_chooser_widget_set_show_all;

    extern fn gtk_app_chooser_widget_set_show_default(self: *Self, setting: bool) void;
    pub const setShowDefault = gtk_app_chooser_widget_set_show_default;

    extern fn gtk_app_chooser_widget_set_show_fallback(self: *Self, setting: bool) void;
    pub const setShowFallback = gtk_app_chooser_widget_set_show_fallback;

    extern fn gtk_app_chooser_widget_set_show_other(self: *Self, setting: bool) void;
    pub const setShowOther = gtk_app_chooser_widget_set_show_other;

    extern fn gtk_app_chooser_widget_set_show_recommended(self: *Self, setting: bool) void;
    ...
    pub inline fn connectApplicationActivated(
        ...
        return c.g_signal_connect_data(self, "application-activated", @ptrCast(callback), data, null, @intFromEnum(flags));
    }
    ...
    pub inline fn connectApplicationActivatedSwapped(
        ...
        return c.g_signal_connect_data(self, "application-activated", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn connectApplicationSelected(
        ...
        return c.g_signal_connect_data(self, "application-selected", @ptrCast(callback), data, null, @intFromEnum(flags));
    }
    ...
    pub inline fn connectApplicationSelectedSwapped(
        ...
        return c.g_signal_connect_data(self, "application-selected", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
