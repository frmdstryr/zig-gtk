...
pub const DragSource = extern struct {
    const Self = @This();
    ...
    // Constructors
    extern fn gtk_drag_source_new() ?*Self;
    ...
    extern fn gtk_drag_source_drag_cancel(self: *Self) void;
    ...
    extern fn gtk_drag_source_get_content(self: *Self) ?*gdk.ContentProvider;
    ...
    extern fn gtk_drag_source_get_drag(self: *Self) ?*gdk.Drag;
    ...
    extern fn gtk_drag_source_set_actions(self: *Self, actions: gdk.DragAction) void;
    ...
    extern fn gtk_drag_source_set_content(self: *Self, content: ?*gdk.ContentProvider) void;
    ...
    extern fn gtk_drag_source_set_icon(self: *Self, paintable: ?*gdk.Paintable, hot_x: i32, hot_y: i32) void;
    ...
    pub inline fn connectDragCancel(
        ...
        return c.g_signal_connect_data(self, "drag-cancel", @ptrCast(callback), data, null, @intFromEnum(flags));
    }
    ...
    pub inline fn connectDragCancelSwapped(
        ...
        return c.g_signal_connect_data(self, "drag-cancel", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
