...
pub const VolumeButton = extern struct {
    ...
    extern fn gtk_scale_button_get_minus_button(self: *Self) ?*gtk.Button;
    ...
    extern fn gtk_scale_button_get_plus_button(self: *Self) ?*gtk.Button;
    pub const getPlusButton = gtk_scale_button_get_plus_button;

    extern fn gtk_scale_button_get_popup(self: *Self) ?*gtk.Widget;
    ...
    extern fn gtk_scale_button_get_value(self: *Self) f64;
    ...
    extern fn gtk_scale_button_set_adjustment(self: *Self, adjustment: *gtk.Adjustment) void;
    ...
    extern fn gtk_scale_button_set_icons(self: *Self, icons: [*c][*c]const u8) void;
    ...
    extern fn gtk_scale_button_set_value(self: *Self, value: f64) void;
    ...
    pub inline fn asScaleButton(self: *Self) *gtk.ScaleButton {
        return @ptrCast(self);
    }
