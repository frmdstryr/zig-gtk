...
pub const NamedAction = extern struct {
    const Self = @This();
    ...
    // Constructors
    extern fn gtk_named_action_new(name: [*c]const u8) ?*Self;
    pub const new = gtk_named_action_new;
    ...
    extern fn gtk_named_action_get_action_name(self: *Self) [*c]const u8;
    pub const getActionName = gtk_named_action_get_action_name;
    ...
    pub inline fn gType() usize {
        return c.gtk_named_action_get_type();
    }
};
