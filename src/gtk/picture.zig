...
pub const Picture = extern struct {
    ...
    pub const new = gtk_picture_new;

    extern fn gtk_picture_new_for_file(file: ?*gio.File) ?*Self;
    pub const newForFile = gtk_picture_new_for_file;

    extern fn gtk_picture_new_for_filename(filename: [*c]const u8) ?*Self;
    pub const newForFilename = gtk_picture_new_for_filename;

    extern fn gtk_picture_new_for_paintable(paintable: ?*gdk.Paintable) ?*Self;
    pub const newForPaintable = gtk_picture_new_for_paintable;

    extern fn gtk_picture_new_for_pixbuf(pixbuf: ?*gdkpixbuf.Pixbuf) ?*Self;
    pub const newForPixbuf = gtk_picture_new_for_pixbuf;

    extern fn gtk_picture_new_for_resource(resource_path: [*c]const u8) ?*Self;
    pub const newForResource = gtk_picture_new_for_resource;
    ...
    extern fn gtk_picture_get_alternative_text(self: *Self) [*c]const u8;
    pub const getAlternativeText = gtk_picture_get_alternative_text;
    ...
    extern fn gtk_picture_get_can_shrink(self: *Self) bool;
    pub const getCanShrink = gtk_picture_get_can_shrink;
    ...
    extern fn gtk_picture_get_file(self: *Self) ?*gio.File;
    pub const getFile = gtk_picture_get_file;
    ...
    extern fn gtk_picture_get_keep_aspect_ratio(self: *Self) bool;
    pub const getKeepAspectRatio = gtk_picture_get_keep_aspect_ratio;
    ...
    extern fn gtk_picture_get_paintable(self: *Self) ?*gdk.Paintable;
    pub const getPaintable = gtk_picture_get_paintable;
    ...
    extern fn gtk_picture_set_alternative_text(self: *Self, alternative_text: [*c]const u8) void;
    pub const setAlternativeText = gtk_picture_set_alternative_text;

    extern fn gtk_widget_set_can_focus(self: *Self, can_focus: bool) void;
    pub const setCanFocus = gtk_widget_set_can_focus;

    extern fn gtk_picture_set_can_shrink(self: *Self, can_shrink: bool) void;
    pub const setCanShrink = gtk_picture_set_can_shrink;
    ...
    extern fn gtk_picture_set_file(self: *Self, file: ?*gio.File) void;
    pub const setFile = gtk_picture_set_file;

    extern fn gtk_picture_set_filename(self: *Self, filename: [*c]const u8) void;
    pub const setFilename = gtk_picture_set_filename;
    ...
    extern fn gtk_picture_set_keep_aspect_ratio(self: *Self, keep_aspect_ratio: bool) void;
    pub const setKeepAspectRatio = gtk_picture_set_keep_aspect_ratio;
    ...
    extern fn gtk_picture_set_paintable(self: *Self, paintable: ?*gdk.Paintable) void;
    pub const setPaintable = gtk_picture_set_paintable;

    extern fn gtk_widget_set_parent(self: *Self, parent: *gtk.Widget) void;
    pub const setParent = gtk_widget_set_parent;

    extern fn gtk_picture_set_pixbuf(self: *Self, pixbuf: ?*gdkpixbuf.Pixbuf) void;
    pub const setPixbuf = gtk_picture_set_pixbuf;
    ...
    extern fn gtk_picture_set_resource(self: *Self, resource_path: [*c]const u8) void;
    pub const setResource = gtk_picture_set_resource;
