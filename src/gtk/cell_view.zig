...
pub const CellView = extern struct {
    ...
    extern fn gtk_cell_view_new_with_context(area: *gtk.CellArea, context: *gtk.CellAreaContext) ?*Self;
    pub const newWithContext = gtk_cell_view_new_with_context;

    extern fn gtk_cell_view_new_with_markup(markup: [*c]const u8) ?*Self;
    pub const newWithMarkup = gtk_cell_view_new_with_markup;

    extern fn gtk_cell_view_new_with_text(text: [*c]const u8) ?*Self;
    pub const newWithText = gtk_cell_view_new_with_text;

    extern fn gtk_cell_view_new_with_texture(texture: *gdk.Texture) ?*Self;
    ...
    extern fn gtk_cell_view_get_displayed_row(self: *Self) ?*gtk.TreePath;
    pub const getDisplayedRow = gtk_cell_view_get_displayed_row;

    extern fn gtk_cell_view_get_draw_sensitive(self: *Self) bool;
    ...
    extern fn gtk_cell_view_get_fit_model(self: *Self) bool;
    ...
    extern fn gtk_cell_view_get_model(self: *Self) ?*gtk.TreeModel;
    ...
    extern fn gtk_cell_view_set_displayed_row(self: *Self, path: ?*gtk.TreePath) void;
    pub const setDisplayedRow = gtk_cell_view_set_displayed_row;

    extern fn gtk_cell_view_set_draw_sensitive(self: *Self, draw_sensitive: bool) void;
    pub const setDrawSensitive = gtk_cell_view_set_draw_sensitive;

    extern fn gtk_cell_view_set_fit_model(self: *Self, fit_model: bool) void;
    ...
    extern fn gtk_cell_view_set_model(self: *Self, model: ?*gtk.TreeModel) void;
