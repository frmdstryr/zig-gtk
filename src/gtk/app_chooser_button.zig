...
pub const AppChooserButton = extern struct {
    ...
    // Constructors
    extern fn gtk_app_chooser_button_new(content_type: [*c]const u8) ?*Self;
    ...
    extern fn gtk_app_chooser_button_append_custom_item(self: *Self, name: [*c]const u8, label: [*c]const u8, icon: *gio.Icon) void;
    pub const appendCustomItem = gtk_app_chooser_button_append_custom_item;

    extern fn gtk_app_chooser_button_append_separator(self: *Self) void;
    ...
    extern fn gtk_app_chooser_button_get_heading(self: *Self) [*c]const u8;
    ...
    extern fn gtk_app_chooser_button_get_modal(self: *Self) bool;
    ...
    extern fn gtk_app_chooser_button_get_show_default_item(self: *Self) bool;
    pub const getShowDefaultItem = gtk_app_chooser_button_get_show_default_item;

    extern fn gtk_app_chooser_button_get_show_dialog_item(self: *Self) bool;
    ...
    extern fn gtk_app_chooser_button_set_active_custom_item(self: *Self, name: [*c]const u8) void;
    ...
    extern fn gtk_app_chooser_button_set_heading(self: *Self, heading: [*c]const u8) void;
    ...
    extern fn gtk_app_chooser_button_set_modal(self: *Self, modal: bool) void;
    ...
    extern fn gtk_app_chooser_button_set_show_default_item(self: *Self, setting: bool) void;
    pub const setShowDefaultItem = gtk_app_chooser_button_set_show_default_item;

    extern fn gtk_app_chooser_button_set_show_dialog_item(self: *Self, setting: bool) void;
    ...
    pub inline fn connectCustomItemActivated(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, item_name: [*c]const u8, data: ?*T) callconv(.C) void,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "custom-item-activated", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectCustomItemActivatedSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, item_name: [*c]const u8) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "custom-item-activated", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
