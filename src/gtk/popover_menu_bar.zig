...
pub const PopoverMenuBar = extern struct {
    const Self = @This();
    ...
    pub const newFromModel = gtk_popover_menu_bar_new_from_model;
    ...
    extern fn gtk_popover_menu_bar_add_child(self: *Self, child: *gtk.Widget, id: [*c]const u8) bool;
    pub const addChild = gtk_popover_menu_bar_add_child;
    ...
    extern fn gtk_popover_menu_bar_get_menu_model(self: *Self) ?*gio.MenuModel;
    pub const getMenuModel = gtk_popover_menu_bar_get_menu_model;
    ...
    extern fn gtk_popover_menu_bar_remove_child(self: *Self, child: *gtk.Widget) bool;
    pub const removeChild = gtk_popover_menu_bar_remove_child;
    ...
    extern fn gtk_popover_menu_bar_set_menu_model(self: *Self, model: ?*gio.MenuModel) void;
    pub const setMenuModel = gtk_popover_menu_bar_set_menu_model;
...
test "gtk.PopoverMenuBar" {
    std.testing.refAllDecls(PopoverMenuBar);
}