...
pub const AlternativeTrigger = extern struct {
    ...
    // Constructors
    extern fn gtk_alternative_trigger_new(first: *gtk.ShortcutTrigger, second: *gtk.ShortcutTrigger) ?*Self;
    ...
    extern fn gtk_alternative_trigger_get_first(self: *Self) ?*gtk.ShortcutTrigger;
    ...
    extern fn gtk_alternative_trigger_get_second(self: *Self) ?*gtk.ShortcutTrigger;
    ...
    pub inline fn gType() usize {
        return c.gtk_alternative_trigger_get_type();
    }
};
