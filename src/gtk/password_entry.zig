...
pub const PasswordEntry = extern struct {
    const Self = @This();
    ...
    // Constructors
    extern fn gtk_password_entry_new() ?*Self;
    pub const new = gtk_password_entry_new;
    ...
    extern fn gtk_password_entry_get_extra_menu(self: *Self) ?*gio.MenuModel;
    pub const getExtraMenu = gtk_password_entry_get_extra_menu;
    ...
    extern fn gtk_password_entry_get_show_peek_icon(self: *Self) bool;
    pub const getShowPeekIcon = gtk_password_entry_get_show_peek_icon;
    ...
    extern fn gtk_password_entry_set_extra_menu(self: *Self, model: ?*gio.MenuModel) void;
    pub const setExtraMenu = gtk_password_entry_set_extra_menu;
    ...
    extern fn gtk_password_entry_set_show_peek_icon(self: *Self, show_peek_icon: bool) void;
    pub const setShowPeekIcon = gtk_password_entry_set_show_peek_icon;
...
test "gtk.PasswordEntry" {
    std.testing.refAllDecls(PasswordEntry);
}