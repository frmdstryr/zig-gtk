...
pub const ListView = extern struct {
    ...
    pub const new = gtk_list_view_new;
    ...
    extern fn gtk_list_view_get_enable_rubberband(self: *Self) bool;
    pub const getEnableRubberband = gtk_list_view_get_enable_rubberband;

    extern fn gtk_list_view_get_factory(self: *Self) ?*gtk.ListItemFactory;
    pub const getFactory = gtk_list_view_get_factory;
    ...
    extern fn gtk_list_view_get_model(self: *Self) ?*gtk.SelectionModel;
    pub const getModel = gtk_list_view_get_model;
    ...
    extern fn gtk_list_view_get_show_separators(self: *Self) bool;
    pub const getShowSeparators = gtk_list_view_get_show_separators;

    extern fn gtk_list_view_get_single_click_activate(self: *Self) bool;
    pub const getSingleClickActivate = gtk_list_view_get_single_click_activate;
    ...
    extern fn gtk_list_view_set_enable_rubberband(self: *Self, enable_rubberband: bool) void;
    pub const setEnableRubberband = gtk_list_view_set_enable_rubberband;

    extern fn gtk_list_view_set_factory(self: *Self, factory: ?*gtk.ListItemFactory) void;
    pub const setFactory = gtk_list_view_set_factory;
    ...
    extern fn gtk_list_view_set_model(self: *Self, model: ?*gtk.SelectionModel) void;
    pub const setModel = gtk_list_view_set_model;
    ...
    extern fn gtk_list_view_set_show_separators(self: *Self, show_separators: bool) void;
    pub const setShowSeparators = gtk_list_view_set_show_separators;

    extern fn gtk_list_view_set_single_click_activate(self: *Self, single_click_activate: bool) void;
    pub const setSingleClickActivate = gtk_list_view_set_single_click_activate;
    ...
    pub inline fn connectActivate(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, position: u32, data: ?*T) callconv(.C) void,
        data: ?*T,
    ...
    pub inline fn connectActivateSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, position: u32) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
    ...
    pub inline fn asListBase(self: *Self) *gtk.ListBase {
        return @ptrCast(self);
    }
