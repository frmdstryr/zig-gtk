...
pub const TreeStore = extern struct {
    ...
    // Methods
    extern fn gtk_tree_store_append(self: *Self, iter: *gtk.TreeIter, parent: ?*gtk.TreeIter) void;
    ...
    extern fn gtk_tree_store_insert(self: *Self, iter: *gtk.TreeIter, parent: ?*gtk.TreeIter, position: i32) void;
    pub const insert = gtk_tree_store_insert;

    extern fn gtk_tree_store_insert_after(self: *Self, iter: *gtk.TreeIter, parent: ?*gtk.TreeIter, sibling: ?*gtk.TreeIter) void;
    pub const insertAfter = gtk_tree_store_insert_after;

    extern fn gtk_tree_store_insert_before(self: *Self, iter: *gtk.TreeIter, parent: ?*gtk.TreeIter, sibling: ?*gtk.TreeIter) void;
    ...
    extern fn gtk_tree_store_prepend(self: *Self, iter: *gtk.TreeIter, parent: ?*gtk.TreeIter) void;
    ...
    extern fn gtk_tree_store_set_valuesv(self: *Self, iter: *gtk.TreeIter, columns: [*c]i32, values: [*c]gobject.Value, n_values: i32) void;
    pub const set = gtk_tree_store_set_valuesv;
    ...
    extern fn gtk_tree_store_set_value(self: *Self, iter: *gtk.TreeIter, column: i32, value: *gobject.Value) void;
