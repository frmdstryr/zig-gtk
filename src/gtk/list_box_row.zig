...
pub const ListBoxRow = extern struct {
    ...
    // Constructors
    extern fn gtk_list_box_row_new() ?*Self;
    ...
    extern fn gtk_list_box_row_changed(self: *Self) void;
    ...
    extern fn gtk_list_box_row_get_activatable(self: *Self) bool;
    ...
    extern fn gtk_list_box_row_get_child(self: *Self) ?*gtk.Widget;
    pub const getChild = gtk_list_box_row_get_child;
    ...
    extern fn gtk_list_box_row_get_header(self: *Self) ?*gtk.Widget;
    ...
    extern fn gtk_list_box_row_get_index(self: *Self) i32;
    ...
    extern fn gtk_list_box_row_get_selectable(self: *Self) bool;
    ...
    extern fn gtk_list_box_row_is_selected(self: *Self) bool;
    ...
    extern fn gtk_list_box_row_set_activatable(self: *Self, activatable: bool) void;
    ...
    extern fn gtk_list_box_row_set_child(self: *Self, child: ?*gtk.Widget) void;
    pub const setChild = gtk_list_box_row_set_child;
    ...
    extern fn gtk_list_box_row_set_header(self: *Self, header: ?*gtk.Widget) void;
    ...
    extern fn gtk_list_box_row_set_selectable(self: *Self, selectable: bool) void;
    ...
    pub fn asActionable(self: *Self) *gtk.Actionable {
        return @ptrCast(self);
    }
...
test {
    std.testing.refAllDecls(ListBoxRow);
}