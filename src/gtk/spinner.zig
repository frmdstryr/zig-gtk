...
pub const Spinner = extern struct {
    ...
    // Constructors
    extern fn gtk_spinner_new() ?*Self;
    ...
    extern fn gtk_spinner_get_spinning(self: *Self) bool;
    pub const getSpinning = gtk_spinner_get_spinning;
    ...
    extern fn gtk_spinner_set_spinning(self: *Self, spinning: bool) void;
    pub const setSpinning = gtk_spinner_set_spinning;
    ...
    extern fn gtk_spinner_start(self: *Self) void;
    ...
    extern fn gtk_spinner_stop(self: *Self) void;
