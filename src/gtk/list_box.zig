...
pub const ListBox = extern struct {
    ...
    extern fn gtk_list_box_bind_model(self: *Self, model: ?*gio.ListModel, create_widget_func: ?*const fn (item: *gobject.Object, user_data: ?*anyopaque) callconv(.C) *gtk.Widget, user_data: ?*anyopaque, user_data_free_func: *const fn (data: ?*anyopaque) callconv(.C) void) void;
    ...
    extern fn gtk_list_box_remove_all(self: *Self) void;
    pub const removeAll = gtk_list_box_remove_all;
    ...
    extern fn gtk_list_box_selected_foreach(self: *Self, func: *const fn (box: *gtk.ListBox, row: *gtk.ListBoxRow, user_data: ?*anyopaque) callconv(.C) void, data: ?*anyopaque) void;
    ...
    extern fn gtk_list_box_set_filter_func(self: *Self, filter_func: ?*const fn (row: *gtk.ListBoxRow, user_data: ?*anyopaque) callconv(.C) bool, user_data: ?*anyopaque, destroy: *const fn (data: ?*anyopaque) callconv(.C) void) void;
    ...
    extern fn gtk_list_box_set_header_func(self: *Self, update_header: ?*const fn (row: *gtk.ListBoxRow, before: ?*gtk.ListBoxRow, user_data: ?*anyopaque) callconv(.C) void, user_data: ?*anyopaque, destroy: *const fn (data: ?*anyopaque) callconv(.C) void) void;
    ...
    extern fn gtk_list_box_set_sort_func(self: *Self, sort_func: ?*const fn (row1: *gtk.ListBoxRow, row2: *gtk.ListBoxRow, user_data: ?*anyopaque) callconv(.C) i32, user_data: ?*anyopaque, destroy: *const fn (data: ?*anyopaque) callconv(.C) void) void;
    ...
    // Signals
    pub inline fn connectActivateCursorRow(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "activate-cursor-row", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectActivateCursorRowSwapped(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "activate-cursor-row", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn connectRowSelected(
        ...
        return c.g_signal_connect_data(self, "row-selected", @ptrCast(callback), data, null, @intFromEnum(flags));
    }
    ...
    pub inline fn connectRowSelectedSwapped(
        ...
        return c.g_signal_connect_data(self, "row-selected", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn connectSelectedRowsChanged(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, data: ?*T) callconv(.C) void,
        data: ?*T,
        ...
        return c.g_signal_connect_data(self, "selected-rows-changed", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectSelectedRowsChangedSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "selected-rows-changed", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
