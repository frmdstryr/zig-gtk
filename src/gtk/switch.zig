...
pub const Switch = extern struct {
    ...
    extern fn gtk_switch_get_active(self: *Self) bool;
    ...
    extern fn gtk_switch_get_state(self: *Self) bool;
    ...
    extern fn gtk_switch_set_active(self: *Self, is_active: bool) void;
    ...
    extern fn gtk_switch_set_state(self: *Self, state: bool) void;
    ...
    pub inline fn connectStateSet(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, state: bool, data: ?*T) callconv(.C) void,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "state-set", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectStateSetSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, state: bool) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "state-set", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
