...
pub const SearchBar = extern struct {
    ...
    // Constructors
    extern fn gtk_search_bar_new() ?*Self;
    ...
    extern fn gtk_search_bar_connect_entry(self: *Self, entry: *gtk.Editable) void;
    ...
    extern fn gtk_search_bar_get_child(self: *Self) ?*gtk.Widget;
    pub const getChild = gtk_search_bar_get_child;
    ...
    extern fn gtk_search_bar_get_key_capture_widget(self: *Self) ?*gtk.Widget;
    pub const getKeyCaptureWidget = gtk_search_bar_get_key_capture_widget;
    ...
    extern fn gtk_search_bar_get_search_mode(self: *Self) bool;
    ...
    extern fn gtk_search_bar_get_show_close_button(self: *Self) bool;
    ...
    extern fn gtk_search_bar_set_child(self: *Self, child: ?*gtk.Widget) void;
    pub const setChild = gtk_search_bar_set_child;
    ...
    extern fn gtk_search_bar_set_key_capture_widget(self: *Self, widget: ?*gtk.Widget) void;
    pub const setKeyCaptureWidget = gtk_search_bar_set_key_capture_widget;
    ...
    extern fn gtk_search_bar_set_search_mode(self: *Self, search_mode: bool) void;
    ...
    extern fn gtk_search_bar_set_show_close_button(self: *Self, visible: bool) void;
    ...
    pub const Properties = enum(u8) {
        child = 0,
        key_capture_widget = 1,
        search_mode_enabled = 2,
        show_close_button = 3,
        can_focus = 4,
        can_target = 5,
        css_classes = 6,
