...
pub const ScrolledWindow = extern struct {
    ...
    // Constructors
    extern fn gtk_scrolled_window_new() ?*Self;
    ...
    extern fn gtk_scrolled_window_get_child(self: *Self) ?*gtk.Widget;
    pub const getChild = gtk_scrolled_window_get_child;
    ...
    extern fn gtk_scrolled_window_get_hadjustment(self: *Self) ?*gtk.Adjustment;
    ...
    extern fn gtk_scrolled_window_get_has_frame(self: *Self) bool;
    pub const getHasFrame = gtk_scrolled_window_get_has_frame;
    ...
    extern fn gtk_scrolled_window_get_hscrollbar(self: *Self) ?*gtk.Widget;
    pub const getHscrollbar = gtk_scrolled_window_get_hscrollbar;

    extern fn gtk_scrolled_window_get_kinetic_scrolling(self: *Self) bool;
    ...
    extern fn gtk_scrolled_window_get_max_content_height(self: *Self) i32;
    pub const getMaxContentHeight = gtk_scrolled_window_get_max_content_height;

    extern fn gtk_scrolled_window_get_max_content_width(self: *Self) i32;
    pub const getMaxContentWidth = gtk_scrolled_window_get_max_content_width;

    extern fn gtk_scrolled_window_get_min_content_height(self: *Self) i32;
    pub const getMinContentHeight = gtk_scrolled_window_get_min_content_height;

    extern fn gtk_scrolled_window_get_min_content_width(self: *Self) i32;
    ...
    extern fn gtk_scrolled_window_get_overlay_scrolling(self: *Self) bool;
    ...
    extern fn gtk_scrolled_window_get_placement(self: *Self) gtk.CornerType;
    pub const getPlacement = gtk_scrolled_window_get_placement;

    extern fn gtk_scrolled_window_get_policy(self: *Self, hscrollbar_policy: gtk.PolicyType, vscrollbar_policy: gtk.PolicyType) void;
    ...
    extern fn gtk_scrolled_window_get_propagate_natural_height(self: *Self) bool;
    pub const getPropagateNaturalHeight = gtk_scrolled_window_get_propagate_natural_height;

    extern fn gtk_scrolled_window_get_propagate_natural_width(self: *Self) bool;
    ...
    extern fn gtk_scrolled_window_get_vadjustment(self: *Self) ?*gtk.Adjustment;
    ...
    extern fn gtk_scrolled_window_get_vscrollbar(self: *Self) ?*gtk.Widget;
    ...
    extern fn gtk_scrolled_window_set_child(self: *Self, child: ?*gtk.Widget) void;
    pub const setChild = gtk_scrolled_window_set_child;
    ...
    extern fn gtk_scrolled_window_set_hadjustment(self: *Self, hadjustment: ?*gtk.Adjustment) void;
    ...
    extern fn gtk_scrolled_window_set_has_frame(self: *Self, has_frame: bool) void;
    pub const setHasFrame = gtk_scrolled_window_set_has_frame;
    ...
    extern fn gtk_scrolled_window_set_kinetic_scrolling(self: *Self, kinetic_scrolling: bool) void;
    ...
    extern fn gtk_scrolled_window_set_max_content_height(self: *Self, height: i32) void;
    pub const setMaxContentHeight = gtk_scrolled_window_set_max_content_height;

    extern fn gtk_scrolled_window_set_max_content_width(self: *Self, width: i32) void;
    pub const setMaxContentWidth = gtk_scrolled_window_set_max_content_width;

    extern fn gtk_scrolled_window_set_min_content_height(self: *Self, height: i32) void;
    pub const setMinContentHeight = gtk_scrolled_window_set_min_content_height;

    extern fn gtk_scrolled_window_set_min_content_width(self: *Self, width: i32) void;
    ...
    extern fn gtk_scrolled_window_set_overlay_scrolling(self: *Self, overlay_scrolling: bool) void;
    ...
    extern fn gtk_scrolled_window_set_placement(self: *Self, window_placement: gtk.CornerType) void;
    pub const setPlacement = gtk_scrolled_window_set_placement;

    extern fn gtk_scrolled_window_set_policy(self: *Self, hscrollbar_policy: gtk.PolicyType, vscrollbar_policy: gtk.PolicyType) void;
    pub const setPolicy = gtk_scrolled_window_set_policy;

    extern fn gtk_scrolled_window_set_propagate_natural_height(self: *Self, propagate: bool) void;
    pub const setPropagateNaturalHeight = gtk_scrolled_window_set_propagate_natural_height;

    extern fn gtk_scrolled_window_set_propagate_natural_width(self: *Self, propagate: bool) void;
    ...
    extern fn gtk_scrolled_window_set_vadjustment(self: *Self, vadjustment: ?*gtk.Adjustment) void;
    ...
    extern fn gtk_scrolled_window_unset_placement(self: *Self) void;
    ...
    // Signals
    pub inline fn connectEdgeOvershot(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, pos: gtk.PositionType, data: ?*T) callconv(.C) void,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "edge-overshot", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectEdgeOvershotSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, pos: gtk.PositionType) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "edge-overshot", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectEdgeReached(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, pos: gtk.PositionType, data: ?*T) callconv(.C) void,
        data: ?*T,
        ...
        return c.g_signal_connect_data(self, "edge-reached", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectEdgeReachedSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, pos: gtk.PositionType) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "edge-reached", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectMoveFocusOut(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, direction_type: gtk.DirectionType, data: ?*T) callconv(.C) void,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
    ...
    pub inline fn connectMoveFocusOutSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, direction_type: gtk.DirectionType) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
    ...
    pub inline fn connectScrollChild(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, scroll: gtk.ScrollType, horizontal: bool, data: ?*T) callconv(.C) void,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "scroll-child", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectScrollChildSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, scroll: gtk.ScrollType, horizontal: bool) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "scroll-child", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub const Properties = enum(u8) {
        ...
        max_content_width = 6,
        min_content_height = 7,
        min_content_width = 8,
        overlay_scrolling = 9,
        propagate_natural_height = 10,
        propagate_natural_width = 11,
        vadjustment = 12,
        vscrollbar_policy = 13,
        window_placement = 14,
        can_focus = 15,
        can_target = 16,
        css_classes = 17,
