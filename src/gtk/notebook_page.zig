...
pub const NotebookPage = extern struct {
    const Self = @This();
    ...
    extern fn gtk_notebook_page_get_child(self: *Self) ?*gtk.Widget;
    pub const getChild = gtk_notebook_page_get_child;
