...
pub const BuilderCScope = extern struct {
    ...
    // Constructors
    extern fn gtk_builder_cscope_new() ?*Self;
    ...
    // Methods
    extern fn gtk_builder_cscope_add_callback_symbol(self: *Self, callback_name: [*c]const u8, callback_symbol: *const fn () callconv(.C) void) void;
    ...
    pub inline fn gType() usize {
        return c.gtk_builder_c_scope_get_type();
    }
};
