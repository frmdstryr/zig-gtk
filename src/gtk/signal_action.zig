...
pub const SignalAction = extern struct {
    ...
    // Constructors
    extern fn gtk_signal_action_new(signal_name: [*c]const u8) ?*Self;
    pub const new = gtk_signal_action_new;
    ...
    extern fn gtk_signal_action_get_signal_name(self: *Self) [*c]const u8;
    pub const getSignalName = gtk_signal_action_get_signal_name;
...
test "gtk.SignalAction" {
    std.testing.refAllDecls(SignalAction);
}