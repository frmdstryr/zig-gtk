...
pub const ShortcutsWindow = extern struct {
    ...
    pub inline fn connectSearch(
        ...
        return c.g_signal_connect_data(self, "search", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectSearchSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "search", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
