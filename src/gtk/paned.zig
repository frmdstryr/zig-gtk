...
pub const Paned = extern struct {
    ...
    // Constructors
    extern fn gtk_paned_new(orientation: gtk.Orientation) ?*Self;
    ...
    extern fn gtk_paned_get_end_child(self: *Self) ?*gtk.Widget;
    pub const getEndChild = gtk_paned_get_end_child;
    ...
    extern fn gtk_paned_get_position(self: *Self) i32;
    ...
    extern fn gtk_paned_get_resize_end_child(self: *Self) bool;
    pub const getResizeEndChild = gtk_paned_get_resize_end_child;

    extern fn gtk_paned_get_resize_start_child(self: *Self) bool;
    pub const getResizeStartChild = gtk_paned_get_resize_start_child;
    ...
    extern fn gtk_paned_get_shrink_end_child(self: *Self) bool;
    pub const getShrinkEndChild = gtk_paned_get_shrink_end_child;

    extern fn gtk_paned_get_shrink_start_child(self: *Self) bool;
    pub const getShrinkStartChild = gtk_paned_get_shrink_start_child;
    ...
    extern fn gtk_paned_get_start_child(self: *Self) ?*gtk.Widget;
    pub const getStartChild = gtk_paned_get_start_child;
    ...
    extern fn gtk_paned_get_wide_handle(self: *Self) bool;
    ...
    extern fn gtk_paned_set_end_child(self: *Self, child: ?*gtk.Widget) void;
    pub const setEndChild = gtk_paned_set_end_child;
    ...
    extern fn gtk_paned_set_position(self: *Self, position: i32) void;
    ...
    extern fn gtk_paned_set_resize_end_child(self: *Self, resize: bool) void;
    pub const setResizeEndChild = gtk_paned_set_resize_end_child;

    extern fn gtk_paned_set_resize_start_child(self: *Self, resize: bool) void;
    pub const setResizeStartChild = gtk_paned_set_resize_start_child;

    extern fn gtk_widget_set_sensitive(self: *Self, sensitive: bool) void;
    pub const setSensitive = gtk_widget_set_sensitive;

    extern fn gtk_paned_set_shrink_end_child(self: *Self, resize: bool) void;
    pub const setShrinkEndChild = gtk_paned_set_shrink_end_child;

    extern fn gtk_paned_set_shrink_start_child(self: *Self, resize: bool) void;
    pub const setShrinkStartChild = gtk_paned_set_shrink_start_child;
    ...
    extern fn gtk_paned_set_start_child(self: *Self, child: ?*gtk.Widget) void;
    pub const setStartChild = gtk_paned_set_start_child;
    ...
    extern fn gtk_paned_set_wide_handle(self: *Self, wide: bool) void;
    ...
    pub inline fn connectAcceptPosition(
        ...
        return c.g_signal_connect_data(self, "accept-position", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectAcceptPositionSwapped(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "accept-position", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn connectCancelPosition(
        ...
        return c.g_signal_connect_data(self, "cancel-position", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectCancelPositionSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "cancel-position", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn connectCycleChildFocus(
        ...
        return c.g_signal_connect_data(self, "cycle-child-focus", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectCycleChildFocusSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, reversed: bool) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "cycle-child-focus", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn connectCycleHandleFocus(
        ...
        return c.g_signal_connect_data(self, "cycle-handle-focus", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectCycleHandleFocusSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, reversed: bool) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "cycle-handle-focus", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn connectMoveHandle(
        ...
        return c.g_signal_connect_data(self, "move-handle", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectMoveHandleSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, scroll_type: gtk.ScrollType) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "move-handle", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn connectToggleHandleFocus(
        ...
        return c.g_signal_connect_data(self, "toggle-handle-focus", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectToggleHandleFocusSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "toggle-handle-focus", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub const Properties = enum(u8) {
        ...
        position_set = 4,
        resize_end_child = 5,
        resize_start_child = 6,
        shrink_end_child = 7,
        shrink_start_child = 8,
        start_child = 9,
        wide_handle = 10,
        can_focus = 11,
        can_target = 12,
