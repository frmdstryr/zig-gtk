...
pub const SpinButton = extern struct {
    ...
    pub inline fn connectChangeValue(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, scroll: *gtk.ScrollType, data: ?*T) callconv(.C) void,
        data: ?*T,
    ...
    pub inline fn connectChangeValueSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, scroll: *gtk.ScrollType) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
    ...
    pub inline fn connectInput(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, new_value: *f64, data: ?*T) callconv(.C) void,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "input", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectInputSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, new_value: *f64) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "input", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectOutput(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "output", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectOutputSwapped(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "output", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn connectWrapped(
        ...
        return c.g_signal_connect_data(self, "wrapped", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectWrappedSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "wrapped", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
