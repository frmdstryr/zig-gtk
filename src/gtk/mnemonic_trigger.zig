...
pub const MnemonicTrigger = extern struct {
    ...
    // Constructors
    extern fn gtk_mnemonic_trigger_new(keyval: u32) ?*Self;
    pub const new = gtk_mnemonic_trigger_new;
    ...
    extern fn gtk_mnemonic_trigger_get_keyval(self: *Self) u32;
    pub const getKeyval = gtk_mnemonic_trigger_get_keyval;
...
test "gtk.MnemonicTrigger" {
    std.testing.refAllDecls(MnemonicTrigger);
}