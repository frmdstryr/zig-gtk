...
pub const EmojiChooser = extern struct {
    const Self = @This();
    ...
    extern fn gtk_popover_get_autohide(self: *Self) bool;
    pub const getAutohide = gtk_popover_get_autohide;
    ...
    extern fn gtk_popover_get_cascade_popdown(self: *Self) bool;
    pub const getCascadePopdown = gtk_popover_get_cascade_popdown;

    extern fn gtk_popover_get_child(self: *Self) ?*gtk.Widget;
    pub const getChild = gtk_popover_get_child;
    ...
    extern fn gtk_popover_get_has_arrow(self: *Self) bool;
    pub const getHasArrow = gtk_popover_get_has_arrow;
    ...
    extern fn gtk_popover_get_mnemonics_visible(self: *Self) bool;
    pub const getMnemonicsVisible = gtk_popover_get_mnemonics_visible;
    ...
    extern fn gtk_popover_get_offset(self: *Self, x_offset: *i32, y_offset: *i32) void;
    pub const getOffset = gtk_popover_get_offset;
    ...
    extern fn gtk_popover_get_pointing_to(self: *Self, rect: *gdk.Rectangle) bool;
    pub const getPointingTo = gtk_popover_get_pointing_to;

    extern fn gtk_popover_get_position(self: *Self) gtk.PositionType;
    ...
    extern fn gtk_popover_popdown(self: *Self) void;
    pub const popdown = gtk_popover_popdown;

    extern fn gtk_popover_popup(self: *Self) void;
    ...
    extern fn gtk_popover_set_autohide(self: *Self, autohide: bool) void;
    pub const setAutohide = gtk_popover_set_autohide;
    ...
    extern fn gtk_popover_set_has_arrow(self: *Self, has_arrow: bool) void;
    pub const setHasArrow = gtk_popover_set_has_arrow;
    ...
    pub const setMnemonicsVisible = gtk_popover_set_mnemonics_visible;

    extern fn gtk_widget_set_name(self: *Self, name: [*c]const u8) void;
    pub const setName = gtk_widget_set_name;

    extern fn gtk_popover_set_offset(self: *Self, x_offset: i32, y_offset: i32) void;
    pub const setOffset = gtk_popover_set_offset;
    ...
    // Signals
    pub inline fn connectEmojiPicked(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, text: [*c]const u8, data: ?*T) callconv(.C) void,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "emoji-picked", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectEmojiPickedSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, text: [*c]const u8) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "emoji-picked", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn asPopover(self: *Self) *gtk.Popover {
        return @ptrCast(self);
    }
