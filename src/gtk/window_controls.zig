...
pub const WindowControls = extern struct {
    const Self = @This();
    ...
    // Constructors
    extern fn gtk_window_controls_new(side: gtk.PackType) ?*Self;
    pub const new = gtk_window_controls_new;
    ...
    extern fn gtk_window_controls_get_decoration_layout(self: *Self) [*c]const u8;
    pub const getDecorationLayout = gtk_window_controls_get_decoration_layout;
    ...
    extern fn gtk_window_controls_get_empty(self: *Self) bool;
    pub const getEmpty = gtk_window_controls_get_empty;
    ...
    extern fn gtk_window_controls_get_side(self: *Self) gtk.PackType;
    pub const getSide = gtk_window_controls_get_side;
    ...
    extern fn gtk_window_controls_set_decoration_layout(self: *Self, layout: [*c]const u8) void;
    pub const setDecorationLayout = gtk_window_controls_set_decoration_layout;
    ...
    extern fn gtk_window_controls_set_side(self: *Self, side: gtk.PackType) void;
    pub const setSide = gtk_window_controls_set_side;
