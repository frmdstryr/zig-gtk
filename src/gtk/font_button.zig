...
pub const FontButton = extern struct {
    ...
    // Constructors
    extern fn gtk_font_button_new() ?*Self;
    pub const new = gtk_font_button_new;

    extern fn gtk_font_button_new_with_font(fontname: [*c]const u8) ?*Self;
    ...
    extern fn gtk_font_button_get_modal(self: *Self) bool;
    ...
    extern fn gtk_font_button_get_title(self: *Self) [*c]const u8;
    ...
    extern fn gtk_font_button_get_use_font(self: *Self) bool;
    pub const getUseFont = gtk_font_button_get_use_font;

    extern fn gtk_font_button_get_use_size(self: *Self) bool;
    ...
    extern fn gtk_font_button_set_modal(self: *Self, modal: bool) void;
    ...
    extern fn gtk_font_button_set_title(self: *Self, title: [*c]const u8) void;
    ...
    extern fn gtk_font_button_set_use_font(self: *Self, use_font: bool) void;
    pub const setUseFont = gtk_font_button_set_use_font;

    extern fn gtk_font_button_set_use_size(self: *Self, use_size: bool) void;
    ...
    pub inline fn connectFontSet(
        ...
        return c.g_signal_connect_data(self, "font-set", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectFontSetSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "font-set", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
