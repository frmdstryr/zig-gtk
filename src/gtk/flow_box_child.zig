...
pub const FlowBoxChild = extern struct {
    ...
    // Constructors
    extern fn gtk_flow_box_child_new() ?*Self;
    ...
    extern fn gtk_flow_box_child_changed(self: *Self) void;
    ...
    extern fn gtk_flow_box_child_get_child(self: *Self) ?*gtk.Widget;
    ...
    extern fn gtk_flow_box_child_get_index(self: *Self) i32;
    ...
    extern fn gtk_flow_box_child_is_selected(self: *Self) bool;
    ...
    extern fn gtk_flow_box_child_set_child(self: *Self, child: ?*gtk.Widget) void;
