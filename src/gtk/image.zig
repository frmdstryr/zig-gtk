...
pub const Image = extern struct {
    ...
    // Constructors
    extern fn gtk_image_new() ?*Self;
    pub const new = gtk_image_new;

    extern fn gtk_image_new_from_file(filename: [*c]const u8) ?*Self;
    pub const newFromFile = gtk_image_new_from_file;

    extern fn gtk_image_new_from_gicon(icon: *gio.Icon) ?*Self;
    pub const newFromGicon = gtk_image_new_from_gicon;

    extern fn gtk_image_new_from_icon_name(icon_name: [*c]const u8) ?*Self;
    pub const newFromIconName = gtk_image_new_from_icon_name;

    extern fn gtk_image_new_from_paintable(paintable: ?*gdk.Paintable) ?*Self;
    pub const newFromPaintable = gtk_image_new_from_paintable;

    extern fn gtk_image_new_from_pixbuf(pixbuf: ?*gdkpixbuf.Pixbuf) ?*Self;
    pub const newFromPixbuf = gtk_image_new_from_pixbuf;

    extern fn gtk_image_new_from_resource(resource_path: [*c]const u8) ?*Self;
    ...
    extern fn gtk_image_clear(self: *Self) void;
    ...
    extern fn gtk_image_get_gicon(self: *Self) ?*gio.Icon;
    ...
    extern fn gtk_image_get_icon_name(self: *Self) [*c]const u8;
    pub const getIconName = gtk_image_get_icon_name;

    extern fn gtk_image_get_icon_size(self: *Self) gtk.IconSize;
    pub const getIconSize = gtk_image_get_icon_size;
    ...
    extern fn gtk_image_get_paintable(self: *Self) ?*gdk.Paintable;
    pub const getPaintable = gtk_image_get_paintable;
    ...
    extern fn gtk_image_get_pixel_size(self: *Self) i32;
    ...
    extern fn gtk_image_get_storage_type(self: *Self) gtk.ImageType;
    ...
    extern fn gtk_image_set_from_file(self: *Self, filename: [*c]const u8) void;
    pub const setFromFile = gtk_image_set_from_file;

    extern fn gtk_image_set_from_gicon(self: *Self, icon: *gio.Icon) void;
    pub const setFromGicon = gtk_image_set_from_gicon;

    extern fn gtk_image_set_from_icon_name(self: *Self, icon_name: [*c]const u8) void;
    pub const setFromIconName = gtk_image_set_from_icon_name;

    extern fn gtk_image_set_from_paintable(self: *Self, paintable: ?*gdk.Paintable) void;
    pub const setFromPaintable = gtk_image_set_from_paintable;

    extern fn gtk_image_set_from_pixbuf(self: *Self, pixbuf: ?*gdkpixbuf.Pixbuf) void;
    pub const setFromPixbuf = gtk_image_set_from_pixbuf;

    extern fn gtk_image_set_from_resource(self: *Self, resource_path: [*c]const u8) void;
    ...
    extern fn gtk_image_set_icon_size(self: *Self, icon_size: gtk.IconSize) void;
    pub const setIconSize = gtk_image_set_icon_size;
    ...
    extern fn gtk_image_set_pixel_size(self: *Self, pixel_size: i32) void;
    ...
    extern fn gtk_widget_set_state_flags(self: *Self, flags: gtk.StateFlags, clear_: bool) void;
