...
pub const FlowBox = extern struct {
    ...
    extern fn gtk_flow_box_selected_foreach(self: *Self, func: gtk.FlowBoxForeachFunc, data: ?*anyopaque) void;
    ...
    extern fn gtk_flow_box_set_sort_func(self: *Self, sort_func: gtk.FlowBoxSortFunc, user_data: ?*anyopaque, destroy: glib.DestroyNotify) void;
