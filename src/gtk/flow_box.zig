...
pub const FlowBox = extern struct {
    ...
    // Constructors
    extern fn gtk_flow_box_new() ?*Self;
    ...
    extern fn gtk_flow_box_bind_model(self: *Self, model: ?*gio.ListModel, create_widget_func: *const fn (item: *gobject.Object, user_data: ?*anyopaque) callconv(.C) *gtk.Widget, user_data: ?*anyopaque, user_data_free_func: *const fn (data: ?*anyopaque) callconv(.C) void) void;
    ...
    extern fn gtk_flow_box_get_activate_on_single_click(self: *Self) bool;
    ...
    extern fn gtk_flow_box_get_child_at_index(self: *Self, idx: i32) ?*gtk.FlowBoxChild;
    pub const getChildAtIndex = gtk_flow_box_get_child_at_index;

    extern fn gtk_flow_box_get_child_at_pos(self: *Self, x: i32, y: i32) ?*gtk.FlowBoxChild;
    ...
    extern fn gtk_flow_box_get_column_spacing(self: *Self) u32;
    ...
    extern fn gtk_flow_box_get_homogeneous(self: *Self) bool;
    ...
    extern fn gtk_flow_box_get_max_children_per_line(self: *Self) u32;
    pub const getMaxChildrenPerLine = gtk_flow_box_get_max_children_per_line;

    extern fn gtk_flow_box_get_min_children_per_line(self: *Self) u32;
    ...
    extern fn gtk_flow_box_get_row_spacing(self: *Self) u32;
    ...
    extern fn gtk_flow_box_get_selected_children(self: *Self) ?*glib.List;
    pub const getSelectedChildren = gtk_flow_box_get_selected_children;

    extern fn gtk_flow_box_get_selection_mode(self: *Self) gtk.SelectionMode;
    ...
    extern fn gtk_flow_box_invalidate_filter(self: *Self) void;
    pub const invalidateFilter = gtk_flow_box_invalidate_filter;

    extern fn gtk_flow_box_invalidate_sort(self: *Self) void;
    ...
    extern fn gtk_flow_box_remove(self: *Self, widget: *gtk.Widget) void;
    pub const remove = gtk_flow_box_remove;

    extern fn gtk_flow_box_remove_all(self: *Self) void;
    ...
    extern fn gtk_flow_box_select_all(self: *Self) void;
    pub const selectAll = gtk_flow_box_select_all;

    extern fn gtk_flow_box_select_child(self: *Self, child: *gtk.FlowBoxChild) void;
    pub const selectChild = gtk_flow_box_select_child;

    extern fn gtk_flow_box_selected_foreach(self: *Self, func: *const fn (box: *gtk.FlowBox, child: *gtk.FlowBoxChild, user_data: ?*anyopaque) callconv(.C) void, data: ?*anyopaque) void;
    pub const selectedForeach = gtk_flow_box_selected_foreach;

    extern fn gtk_flow_box_set_activate_on_single_click(self: *Self, single: bool) void;
    ...
    extern fn gtk_flow_box_set_column_spacing(self: *Self, spacing: u32) void;
    ...
    extern fn gtk_flow_box_set_filter_func(self: *Self, filter_func: ?*const fn (child: *gtk.FlowBoxChild, user_data: ?*anyopaque) callconv(.C) bool, user_data: ?*anyopaque, destroy: *const fn (data: ?*anyopaque) callconv(.C) void) void;
    ...
    extern fn gtk_flow_box_set_max_children_per_line(self: *Self, n_children: u32) void;
    pub const setMaxChildrenPerLine = gtk_flow_box_set_max_children_per_line;

    extern fn gtk_flow_box_set_min_children_per_line(self: *Self, n_children: u32) void;
    ...
    extern fn gtk_flow_box_set_row_spacing(self: *Self, spacing: u32) void;
    pub const setRowSpacing = gtk_flow_box_set_row_spacing;

    extern fn gtk_flow_box_set_selection_mode(self: *Self, mode: gtk.SelectionMode) void;
    ...
    extern fn gtk_flow_box_set_sort_func(self: *Self, sort_func: ?*const fn (child1: *gtk.FlowBoxChild, child2: *gtk.FlowBoxChild, user_data: ?*anyopaque) callconv(.C) i32, user_data: ?*anyopaque, destroy: *const fn (data: ?*anyopaque) callconv(.C) void) void;
    ...
    extern fn gtk_flow_box_set_vadjustment(self: *Self, adjustment: *gtk.Adjustment) void;
    ...
    extern fn gtk_flow_box_unselect_all(self: *Self) void;
    pub const unselectAll = gtk_flow_box_unselect_all;

    extern fn gtk_flow_box_unselect_child(self: *Self, child: *gtk.FlowBoxChild) void;
    ...
    // Signals
    pub inline fn connectActivateCursorChild(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "activate-cursor-child", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectActivateCursorChildSwapped(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "activate-cursor-child", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectChildActivated(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, child: *gtk.FlowBoxChild, data: ?*T) callconv(.C) void,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "child-activated", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectChildActivatedSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, child: *gtk.FlowBoxChild) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "child-activated", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectMoveCursor(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, step: gtk.MovementStep, count: i32, extend: bool, modify: bool, data: ?*T) callconv(.C) void,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
    ...
    pub inline fn connectMoveCursorSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, step: gtk.MovementStep, count: i32, extend: bool, modify: bool) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
    ...
    pub inline fn connectSelectedChildrenChanged(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, data: ?*T) callconv(.C) void,
        data: ?*T,
        ...
        return c.g_signal_connect_data(self, "selected-children-changed", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectSelectedChildrenChangedSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "selected-children-changed", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectToggleCursorChild(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, data: ?*T) callconv(.C) void,
        data: ?*T,
        ...
        return c.g_signal_connect_data(self, "toggle-cursor-child", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectToggleCursorChildSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "toggle-cursor-child", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub const Properties = enum(u8) {
        accept_unpaired_release = 0,
        activate_on_single_click = 1,
        column_spacing = 2,
        homogeneous = 3,
