...
pub const ColorButton = extern struct {
    ...
    // Constructors
    extern fn gtk_color_button_new() ?*Self;
    pub const new = gtk_color_button_new;

    extern fn gtk_color_button_new_with_rgba(rgba: *gdk.RGBA) ?*Self;
    ...
    extern fn gtk_color_button_get_modal(self: *Self) bool;
    ...
    extern fn gtk_color_button_get_title(self: *Self) [*c]const u8;
    ...
    extern fn gtk_color_button_set_modal(self: *Self, modal: bool) void;
    ...
    extern fn gtk_color_button_set_title(self: *Self, title: [*c]const u8) void;
    ...
    pub inline fn connectColorSet(
        ...
        return c.g_signal_connect_data(self, "color-set", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectColorSetSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "color-set", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
