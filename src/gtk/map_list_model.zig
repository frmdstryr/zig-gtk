...
pub const MapListModel = extern struct {
    ...
    // Constructors
    extern fn gtk_map_list_model_new(model: ?*gio.ListModel, map_func: ?*const fn (item: *gobject.Object, user_data: ?*anyopaque) callconv(.C) *gobject.Object, user_data: ?*anyopaque, user_destroy: *const fn (data: ?*anyopaque) callconv(.C) void) ?*Self;
    ...
    extern fn gtk_map_list_model_set_map_func(self: *Self, map_func: ?*const fn (item: *gobject.Object, user_data: ?*anyopaque) callconv(.C) *gobject.Object, user_data: ?*anyopaque, user_destroy: *const fn (data: ?*anyopaque) callconv(.C) void) void;
