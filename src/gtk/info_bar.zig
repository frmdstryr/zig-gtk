...
pub const InfoBar = extern struct {
    ...
    // Constructors
    extern fn gtk_info_bar_new() ?*Self;
    ...
    extern fn gtk_info_bar_add_action_widget(self: *Self, child: *gtk.Widget, response_id: i32) void;
    pub const addActionWidget = gtk_info_bar_add_action_widget;

    extern fn gtk_info_bar_add_button(self: *Self, button_text: [*c]const u8, response_id: i32) ?*gtk.Button;
    pub const addButton = gtk_info_bar_add_button;

    extern fn gtk_info_bar_add_child(self: *Self, widget: *gtk.Widget) void;
    pub const addChild = gtk_info_bar_add_child;
    ...
    extern fn gtk_info_bar_get_message_type(self: *Self) gtk.MessageType;
    ...
    extern fn gtk_info_bar_get_revealed(self: *Self) bool;
    ...
    extern fn gtk_info_bar_get_show_close_button(self: *Self) bool;
    ...
    extern fn gtk_info_bar_remove_action_widget(self: *Self, widget: *gtk.Widget) void;
    pub const removeActionWidget = gtk_info_bar_remove_action_widget;

    extern fn gtk_info_bar_remove_child(self: *Self, widget: *gtk.Widget) void;
    pub const removeChild = gtk_info_bar_remove_child;
    ...
    extern fn gtk_info_bar_response(self: *Self, response_id: i32) void;
    ...
    extern fn gtk_info_bar_set_default_response(self: *Self, response_id: i32) void;
    ...
    extern fn gtk_info_bar_set_message_type(self: *Self, message_type: gtk.MessageType) void;
    ...
    extern fn gtk_info_bar_set_response_sensitive(self: *Self, response_id: i32, setting: bool) void;
    pub const setResponseSensitive = gtk_info_bar_set_response_sensitive;

    extern fn gtk_info_bar_set_revealed(self: *Self, revealed: bool) void;
    ...
    extern fn gtk_info_bar_set_show_close_button(self: *Self, setting: bool) void;
