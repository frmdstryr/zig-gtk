...
pub const Notebook = extern struct {
    ...
    // Constructors
    extern fn gtk_notebook_new() ?*Self;
    ...
    extern fn gtk_notebook_detach_tab(self: *Self, child: *gtk.Widget) void;
    ...
    extern fn gtk_notebook_get_action_widget(self: *Self, pack_type: gtk.PackType) ?*gtk.Widget;
    ...
    extern fn gtk_notebook_get_current_page(self: *Self) i32;
    ...
    extern fn gtk_notebook_get_group_name(self: *Self) [*c]const u8;
    ...
    extern fn gtk_notebook_get_menu_label(self: *Self, child: *gtk.Widget) ?*gtk.Widget;
    pub const getMenuLabel = gtk_notebook_get_menu_label;

    extern fn gtk_notebook_get_menu_label_text(self: *Self, child: *gtk.Widget) [*c]const u8;
    pub const getMenuLabelText = gtk_notebook_get_menu_label_text;

    extern fn gtk_notebook_get_n_pages(self: *Self) i32;
    ...
    extern fn gtk_notebook_get_nth_page(self: *Self, page_num: i32) ?*gtk.Widget;
    ...
    extern fn gtk_notebook_get_page(self: *Self, child: *gtk.Widget) ?*gtk.NotebookPage;
    pub const getPage = gtk_notebook_get_page;

    extern fn gtk_notebook_get_pages(self: *Self) ?*gio.ListModel;
    pub const getPages = gtk_notebook_get_pages;
    ...
    extern fn gtk_notebook_get_scrollable(self: *Self) bool;
    ...
    extern fn gtk_notebook_get_show_border(self: *Self) bool;
    pub const getShowBorder = gtk_notebook_get_show_border;

    extern fn gtk_notebook_get_show_tabs(self: *Self) bool;
    ...
    extern fn gtk_notebook_get_tab_detachable(self: *Self, child: *gtk.Widget) bool;
    pub const getTabDetachable = gtk_notebook_get_tab_detachable;

    extern fn gtk_notebook_get_tab_label(self: *Self, child: *gtk.Widget) ?*gtk.Widget;
    pub const getTabLabel = gtk_notebook_get_tab_label;

    extern fn gtk_notebook_get_tab_label_text(self: *Self, child: *gtk.Widget) [*c]const u8;
    pub const getTabLabelText = gtk_notebook_get_tab_label_text;

    extern fn gtk_notebook_get_tab_pos(self: *Self) gtk.PositionType;
    pub const getTabPos = gtk_notebook_get_tab_pos;

    extern fn gtk_notebook_get_tab_reorderable(self: *Self, child: *gtk.Widget) bool;
    ...
    extern fn gtk_notebook_next_page(self: *Self) void;
    ...
    extern fn gtk_notebook_page_num(self: *Self, child: *gtk.Widget) i32;
    ...
    extern fn gtk_notebook_popup_disable(self: *Self) void;
    ...
    extern fn gtk_notebook_remove_page(self: *Self, page_num: i32) void;
    ...
    extern fn gtk_notebook_reorder_child(self: *Self, child: *gtk.Widget, position: i32) void;
    pub const reorderChild = gtk_notebook_reorder_child;

    extern fn g_object_run_dispose(self: *Self) void;
    pub const runDispose = g_object_run_dispose;

    extern fn gtk_notebook_set_action_widget(self: *Self, widget: *gtk.Widget, pack_type: gtk.PackType) void;
    ...
    extern fn gtk_notebook_set_scrollable(self: *Self, scrollable: bool) void;
    ...
    extern fn gtk_notebook_set_show_border(self: *Self, show_border: bool) void;
    pub const setShowBorder = gtk_notebook_set_show_border;

    extern fn gtk_notebook_set_show_tabs(self: *Self, show_tabs: bool) void;
    ...
    extern fn gtk_notebook_set_tab_pos(self: *Self, pos: gtk.PositionType) void;
    pub const setTabPos = gtk_notebook_set_tab_pos;

    extern fn gtk_notebook_set_tab_reorderable(self: *Self, child: *gtk.Widget, reorderable: bool) void;
    ...
    pub inline fn connectChangeCurrentPage(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, object: i32, data: ?*T) callconv(.C) bool,
        data: ?*T,
    ...
    pub inline fn connectCreateWindow(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, page: *gtk.Widget, data: ?*T) callconv(.C) gtk.Notebook,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
    ...
    pub inline fn connectFocusTab(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, object: gtk.NotebookTab, data: ?*T) callconv(.C) bool,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
    ...
    pub inline fn connectReorderTab(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, object: gtk.DirectionType, p0: bool, data: ?*T) callconv(.C) bool,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
