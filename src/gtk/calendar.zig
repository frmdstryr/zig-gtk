...
pub const Calendar = extern struct {
    ...
    // Constructors
    extern fn gtk_calendar_new() ?*Self;
    ...
    extern fn gtk_calendar_clear_marks(self: *Self) void;
    ...
    extern fn gtk_calendar_get_date(self: *Self) ?*glib.DateTime;
    pub const getDate = gtk_calendar_get_date;

    extern fn gtk_calendar_get_day_is_marked(self: *Self, day: u32) bool;
    ...
    extern fn gtk_calendar_get_show_day_names(self: *Self) bool;
    pub const getShowDayNames = gtk_calendar_get_show_day_names;

    extern fn gtk_calendar_get_show_heading(self: *Self) bool;
    pub const getShowHeading = gtk_calendar_get_show_heading;

    extern fn gtk_calendar_get_show_week_numbers(self: *Self) bool;
    ...
    extern fn gtk_calendar_mark_day(self: *Self, day: u32) void;
    ...
    extern fn gtk_calendar_select_day(self: *Self, date: *glib.DateTime) void;
    ...
    extern fn gtk_calendar_set_show_day_names(self: *Self, value: bool) void;
    pub const setShowDayNames = gtk_calendar_set_show_day_names;

    extern fn gtk_calendar_set_show_heading(self: *Self, value: bool) void;
    pub const setShowHeading = gtk_calendar_set_show_heading;

    extern fn gtk_calendar_set_show_week_numbers(self: *Self, value: bool) void;
    ...
    extern fn gtk_calendar_unmark_day(self: *Self, day: u32) void;
    ...
    // Signals
    pub inline fn connectDaySelected(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "day-selected", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectDaySelectedSwapped(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "day-selected", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectNextMonth(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, data: ?*T) callconv(.C) void,
        data: ?*T,
        ...
        return c.g_signal_connect_data(self, "next-month", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectNextMonthSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "next-month", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectNextYear(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, data: ?*T) callconv(.C) void,
        data: ?*T,
        ...
        return c.g_signal_connect_data(self, "next-year", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectNextYearSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "next-year", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectPrevMonth(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, data: ?*T) callconv(.C) void,
        data: ?*T,
        ...
        return c.g_signal_connect_data(self, "prev-month", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectPrevMonthSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "prev-month", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectPrevYear(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, data: ?*T) callconv(.C) void,
        data: ?*T,
        ...
        return c.g_signal_connect_data(self, "prev-year", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectPrevYearSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "prev-year", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
