...
pub const Viewport = extern struct {
    ...
    // Constructors
    extern fn gtk_viewport_new(hadjustment: ?*gtk.Adjustment, vadjustment: ?*gtk.Adjustment) ?*Self;
    ...
    extern fn gtk_viewport_get_child(self: *Self) ?*gtk.Widget;
    pub const getChild = gtk_viewport_get_child;
    ...
    extern fn gtk_viewport_get_scroll_to_focus(self: *Self) bool;
    pub const getScrollToFocus = gtk_viewport_get_scroll_to_focus;
    ...
    extern fn gtk_viewport_scroll_to(self: *Self, descendant: *gtk.Widget, scroll: ?*gtk.ScrollInfo) void;
    pub const scrollTo = gtk_viewport_scroll_to;
    ...
    extern fn gtk_viewport_set_child(self: *Self, child: ?*gtk.Widget) void;
    pub const setChild = gtk_viewport_set_child;
    ...
    extern fn gtk_viewport_set_scroll_to_focus(self: *Self, scroll_to_focus: bool) void;
    pub const setScrollToFocus = gtk_viewport_set_scroll_to_focus;
