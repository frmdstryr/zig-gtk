...
pub const Revealer = extern struct {
    ...
    // Constructors
    extern fn gtk_revealer_new() ?*Self;
    ...
    extern fn gtk_revealer_get_child(self: *Self) ?*gtk.Widget;
    pub const getChild = gtk_revealer_get_child;

    extern fn gtk_revealer_get_child_revealed(self: *Self) bool;
    ...
    extern fn gtk_revealer_get_reveal_child(self: *Self) bool;
    ...
    extern fn gtk_revealer_get_transition_duration(self: *Self) u32;
    pub const getTransitionDuration = gtk_revealer_get_transition_duration;

    extern fn gtk_revealer_get_transition_type(self: *Self) gtk.RevealerTransitionType;
    ...
    extern fn gtk_revealer_set_child(self: *Self, child: ?*gtk.Widget) void;
    pub const setChild = gtk_revealer_set_child;
    ...
    extern fn gtk_revealer_set_reveal_child(self: *Self, reveal_child: bool) void;
    ...
    extern fn gtk_revealer_set_transition_duration(self: *Self, duration: u32) void;
    pub const setTransitionDuration = gtk_revealer_set_transition_duration;

    extern fn gtk_revealer_set_transition_type(self: *Self, transition: gtk.RevealerTransitionType) void;
