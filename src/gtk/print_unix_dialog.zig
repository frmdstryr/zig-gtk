...
pub const PrintUnixDialog = extern struct {
    const Self = @This();
    ...
    // Constructors
    extern fn gtk_print_unix_dialog_new(title: [*c]const u8, parent: ?*gtk.Window) ?*Self;
    pub const new = gtk_print_unix_dialog_new;
    ...
    extern fn gtk_dialog_add_action_widget(self: *Self, child: *gtk.Widget, response_id: i32) void;
    ...
    extern fn gtk_print_unix_dialog_add_custom_tab(self: *Self, child: *gtk.Widget, tab_label: *gtk.Widget) void;
    pub const addCustomTab = gtk_print_unix_dialog_add_custom_tab;
    ...
    extern fn gtk_print_unix_dialog_get_current_page(self: *Self) i32;
    pub const getCurrentPage = gtk_print_unix_dialog_get_current_page;
    ...
    extern fn gtk_print_unix_dialog_get_embed_page_setup(self: *Self) bool;
    pub const getEmbedPageSetup = gtk_print_unix_dialog_get_embed_page_setup;
    ...
    extern fn gtk_print_unix_dialog_get_has_selection(self: *Self) bool;
    pub const getHasSelection = gtk_print_unix_dialog_get_has_selection;

    extern fn gtk_widget_get_has_tooltip(self: *Self) bool;
    pub const getHasTooltip = gtk_widget_get_has_tooltip;

    extern fn gtk_dialog_get_header_bar(self: *Self) ?*gtk.HeaderBar;
    ...
    extern fn gtk_print_unix_dialog_get_manual_capabilities(self: *Self) gtk.PrintCapabilities;
    pub const getManualCapabilities = gtk_print_unix_dialog_get_manual_capabilities;
    ...
    extern fn gtk_print_unix_dialog_get_page_setup(self: *Self) ?*gtk.PageSetup;
    pub const getPageSetup = gtk_print_unix_dialog_get_page_setup;

    extern fn gtk_print_unix_dialog_get_page_setup_set(self: *Self) bool;
    pub const getPageSetupSet = gtk_print_unix_dialog_get_page_setup_set;
    ...
    extern fn gtk_dialog_get_response_for_widget(self: *Self, widget: *gtk.Widget) i32;
    ...
    extern fn gtk_print_unix_dialog_get_selected_printer(self: *Self) ?*gtk.Printer;
    pub const getSelectedPrinter = gtk_print_unix_dialog_get_selected_printer;

    extern fn gtk_widget_get_sensitive(self: *Self) bool;
    pub const getSensitive = gtk_widget_get_sensitive;

    extern fn gtk_print_unix_dialog_get_settings(self: *Self) ?*gtk.PrintSettings;
    pub const getSettings = gtk_print_unix_dialog_get_settings;
    ...
    extern fn gtk_print_unix_dialog_get_support_selection(self: *Self) bool;
    pub const getSupportSelection = gtk_print_unix_dialog_get_support_selection;
    ...
    extern fn gtk_dialog_get_widget_for_response(self: *Self, response_id: i32) ?*gtk.Widget;
    ...
    extern fn gtk_print_unix_dialog_set_current_page(self: *Self, current_page: i32) void;
    pub const setCurrentPage = gtk_print_unix_dialog_set_current_page;
    ...
    extern fn gtk_dialog_set_default_response(self: *Self, response_id: i32) void;
    ...
    extern fn gtk_print_unix_dialog_set_embed_page_setup(self: *Self, embed: bool) void;
    pub const setEmbedPageSetup = gtk_print_unix_dialog_set_embed_page_setup;
    ...
    extern fn gtk_print_unix_dialog_set_has_selection(self: *Self, has_selection: bool) void;
    pub const setHasSelection = gtk_print_unix_dialog_set_has_selection;
    ...
    extern fn gtk_print_unix_dialog_set_manual_capabilities(self: *Self, capabilities: gtk.PrintCapabilities) void;
    pub const setManualCapabilities = gtk_print_unix_dialog_set_manual_capabilities;
    ...
    extern fn gtk_print_unix_dialog_set_page_setup(self: *Self, page_setup: *gtk.PageSetup) void;
    pub const setPageSetup = gtk_print_unix_dialog_set_page_setup;
    ...
    extern fn gtk_print_unix_dialog_set_settings(self: *Self, settings: ?*gtk.PrintSettings) void;
    pub const setSettings = gtk_print_unix_dialog_set_settings;
    ...
    extern fn gtk_print_unix_dialog_set_support_selection(self: *Self, support_selection: bool) void;
    pub const setSupportSelection = gtk_print_unix_dialog_set_support_selection;
    ...
    pub inline fn connectClose(
        ...
        return c.g_signal_connect_data(self, "close", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectCloseSwapped(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "close", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn connectActivateDefault(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, data: ?*T) callconv(.C) void,
        data: ?*T,
        ...
        return c.g_signal_connect_data(self, "activate-default", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectActivateDefaultSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "activate-default", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectActivateFocus(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, data: ?*T) callconv(.C) void,
        data: ?*T,
        ...
        return c.g_signal_connect_data(self, "activate-focus", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectActivateFocusSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "activate-focus", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn connectCloseRequest(
        ...
        return c.g_signal_connect_data(self, "close-request", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectCloseRequestSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "close-request", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn connectEnableDebugging(
        ...
        return c.g_signal_connect_data(self, "enable-debugging", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectEnableDebuggingSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, toggle: bool) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "enable-debugging", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectKeysChanged(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, data: ?*T) callconv(.C) void,
        data: ?*T,
        ...
        return c.g_signal_connect_data(self, "keys-changed", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectKeysChangedSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "keys-changed", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub const Properties = enum(u8) {
        ...
        default_width = 14,
        deletable = 15,
        destroy_with_parent = 16,
        display = 17,
        focus_visible = 18,
        focus_widget = 19,
        fullscreened = 20,
        handle_menubar_accel = 21,
        hide_on_close = 22,
        icon_name = 23,
        is_active = 24,
        maximized = 25,
        mnemonics_visible = 26,
        modal = 27,
        resizable = 28,
        startup_id = 29,
        title = 30,
    ...
    pub inline fn asDialog(self: *Self) *gtk.Dialog {
        return @ptrCast(self);
    }
    ...
    pub inline fn gType() usize {
        return c.gtk_print_unix_dialog_get_type();
    }
};
