...
pub const GridView = extern struct {
    ...
    // Constructors
    extern fn gtk_grid_view_new(model: ?*gtk.SelectionModel, factory: ?*gtk.ListItemFactory) ?*Self;
    ...
    extern fn gtk_grid_view_get_enable_rubberband(self: *Self) bool;
    pub const getEnableRubberband = gtk_grid_view_get_enable_rubberband;

    extern fn gtk_grid_view_get_factory(self: *Self) ?*gtk.ListItemFactory;
    ...
    extern fn gtk_grid_view_get_max_columns(self: *Self) u32;
    pub const getMaxColumns = gtk_grid_view_get_max_columns;

    extern fn gtk_grid_view_get_min_columns(self: *Self) u32;
    pub const getMinColumns = gtk_grid_view_get_min_columns;

    extern fn gtk_grid_view_get_model(self: *Self) ?*gtk.SelectionModel;
    ...
    extern fn gtk_grid_view_get_single_click_activate(self: *Self) bool;
    ...
    extern fn gtk_grid_view_set_enable_rubberband(self: *Self, enable_rubberband: bool) void;
    pub const setEnableRubberband = gtk_grid_view_set_enable_rubberband;

    extern fn gtk_grid_view_set_factory(self: *Self, factory: ?*gtk.ListItemFactory) void;
    ...
    extern fn gtk_grid_view_set_max_columns(self: *Self, max_columns: u32) void;
    pub const setMaxColumns = gtk_grid_view_set_max_columns;

    extern fn gtk_grid_view_set_min_columns(self: *Self, min_columns: u32) void;
    pub const setMinColumns = gtk_grid_view_set_min_columns;

    extern fn gtk_grid_view_set_model(self: *Self, model: ?*gtk.SelectionModel) void;
