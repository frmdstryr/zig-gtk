...
pub const ActionBar = extern struct {
    ...
    // Constructors
    extern fn gtk_action_bar_new() ?*Self;
    ...
    extern fn gtk_action_bar_get_center_widget(self: *Self) ?*gtk.Widget;
    ...
    extern fn gtk_action_bar_get_revealed(self: *Self) bool;
    ...
    extern fn gtk_action_bar_pack_end(self: *Self, child: *gtk.Widget) void;
    pub const packEnd = gtk_action_bar_pack_end;

    extern fn gtk_action_bar_pack_start(self: *Self, child: *gtk.Widget) void;
    ...
    extern fn gtk_action_bar_remove(self: *Self, child: *gtk.Widget) void;
    ...
    extern fn gtk_action_bar_set_center_widget(self: *Self, center_widget: ?*gtk.Widget) void;
    ...
    extern fn gtk_action_bar_set_revealed(self: *Self, revealed: bool) void;
