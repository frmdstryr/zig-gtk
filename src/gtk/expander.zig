...
pub const Expander = extern struct {
    ...
    // Constructors
    extern fn gtk_expander_new(label: [*c]const u8) ?*Self;
    pub const new = gtk_expander_new;

    extern fn gtk_expander_new_with_mnemonic(label: [*c]const u8) ?*Self;
    ...
    extern fn gtk_expander_get_child(self: *Self) ?*gtk.Widget;
    ...
    extern fn gtk_expander_get_expanded(self: *Self) bool;
    ...
    extern fn gtk_expander_get_label(self: *Self) [*c]const u8;
    pub const getLabel = gtk_expander_get_label;

    extern fn gtk_expander_get_label_widget(self: *Self) ?*gtk.Widget;
    ...
    extern fn gtk_expander_get_resize_toplevel(self: *Self) bool;
    ...
    extern fn gtk_expander_get_use_markup(self: *Self) bool;
    pub const getUseMarkup = gtk_expander_get_use_markup;

    extern fn gtk_expander_get_use_underline(self: *Self) bool;
    ...
    extern fn gtk_expander_set_child(self: *Self, child: ?*gtk.Widget) void;
    ...
    extern fn gtk_expander_set_expanded(self: *Self, expanded: bool) void;
    ...
    extern fn gtk_expander_set_label(self: *Self, label: [*c]const u8) void;
    pub const setLabel = gtk_expander_set_label;

    extern fn gtk_expander_set_label_widget(self: *Self, label_widget: ?*gtk.Widget) void;
    ...
    extern fn gtk_expander_set_resize_toplevel(self: *Self, resize_toplevel: bool) void;
    ...
    extern fn gtk_expander_set_use_markup(self: *Self, use_markup: bool) void;
    pub const setUseMarkup = gtk_expander_set_use_markup;

    extern fn gtk_expander_set_use_underline(self: *Self, use_underline: bool) void;
