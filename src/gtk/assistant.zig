...
pub const Assistant = extern struct {
    ...
    // Constructors
    extern fn gtk_assistant_new() ?*Self;
    ...
    extern fn gtk_assistant_add_action_widget(self: *Self, child: *gtk.Widget) void;
    ...
    extern fn gtk_assistant_append_page(self: *Self, page: *gtk.Widget) i32;
    ...
    extern fn gtk_assistant_commit(self: *Self) void;
    ...
    extern fn gtk_assistant_get_current_page(self: *Self) i32;
    ...
    extern fn gtk_assistant_get_n_pages(self: *Self) i32;
    ...
    extern fn gtk_assistant_get_nth_page(self: *Self, page_num: i32) ?*gtk.Widget;
    ...
    extern fn gtk_assistant_get_page(self: *Self, child: *gtk.Widget) ?*gtk.AssistantPage;
    pub const getPage = gtk_assistant_get_page;

    extern fn gtk_assistant_get_page_complete(self: *Self, page: *gtk.Widget) bool;
    pub const getPageComplete = gtk_assistant_get_page_complete;

    extern fn gtk_assistant_get_page_title(self: *Self, page: *gtk.Widget) [*c]const u8;
    pub const getPageTitle = gtk_assistant_get_page_title;

    extern fn gtk_assistant_get_page_type(self: *Self, page: *gtk.Widget) gtk.AssistantPageType;
    pub const getPageType = gtk_assistant_get_page_type;

    extern fn gtk_assistant_get_pages(self: *Self) ?*gio.ListModel;
    ...
    extern fn gtk_assistant_insert_page(self: *Self, page: *gtk.Widget, position: i32) i32;
    ...
    extern fn gtk_assistant_next_page(self: *Self) void;
    ...
    extern fn gtk_assistant_prepend_page(self: *Self, page: *gtk.Widget) i32;
    ...
    extern fn gtk_assistant_previous_page(self: *Self) void;
    ...
    extern fn gtk_assistant_remove_action_widget(self: *Self, child: *gtk.Widget) void;
    ...
    extern fn gtk_assistant_remove_page(self: *Self, page_num: i32) void;
    ...
    extern fn gtk_assistant_set_current_page(self: *Self, page_num: i32) void;
    ...
    extern fn gtk_assistant_set_page_complete(self: *Self, page: *gtk.Widget, complete: bool) void;
    ...
    extern fn gtk_assistant_update_buttons_state(self: *Self) void;
    ...
    pub inline fn connectApply(
        ...
        return c.g_signal_connect_data(self, "apply", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectApplySwapped(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "apply", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn connectEscape(
        ...
        return c.g_signal_connect_data(self, "escape", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectEscapeSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "escape", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn connectPrepare(
        ...
        return c.g_signal_connect_data(self, "prepare", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectPrepareSwapped(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "prepare", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub const Properties = enum(u8) {
        ...
        default_width = 7,
        deletable = 8,
        destroy_with_parent = 9,
        display = 10,
        focus_visible = 11,
        focus_widget = 12,
        fullscreened = 13,
        handle_menubar_accel = 14,
        hide_on_close = 15,
        icon_name = 16,
        is_active = 17,
        maximized = 18,
        mnemonics_visible = 19,
        modal = 20,
        resizable = 21,
        startup_id = 22,
        title = 23,
