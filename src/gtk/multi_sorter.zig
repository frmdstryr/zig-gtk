...
pub const MultiSorter = extern struct {
    ...
    pub const new = gtk_multi_sorter_new;
    ...
    // Methods
    extern fn gtk_multi_sorter_append(self: *Self, sorter: *gtk.Sorter) void;
    pub const append = gtk_multi_sorter_append;
    ...
    extern fn gtk_multi_sorter_remove(self: *Self, position: u32) void;
    pub const remove = gtk_multi_sorter_remove;
