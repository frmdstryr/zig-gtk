...
pub const FixedLayoutChild = extern struct {
    ...
    extern fn gtk_fixed_layout_child_get_transform(self: *Self) ?*gsk.Transform;
    ...
    extern fn gtk_fixed_layout_child_set_transform(self: *Self, transform: *gsk.Transform) void;
