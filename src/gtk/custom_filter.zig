...
pub const CustomFilter = extern struct {
    ...
    extern fn gtk_custom_filter_set_filter_func(self: *Self, match_func: ?*const fn (item: *gobject.Object, user_data: ?*anyopaque) callconv(.C) bool, user_data: ?*anyopaque, user_destroy: *const fn (data: ?*anyopaque) callconv(.C) void) void;
