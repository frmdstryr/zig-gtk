...
pub const CustomFilter = extern struct {
    const Self = @This();

    parent_instance: *anyopaque,

    // Constructors
    extern fn gtk_custom_filter_new(match_func: gtk.CustomFilterFunc, user_data: ?*anyopaque, user_destroy: glib.DestroyNotify) ?*Self;
    ...
    extern fn gtk_custom_filter_set_filter_func(self: *Self, match_func: gtk.CustomFilterFunc, user_data: ?*anyopaque, user_destroy: glib.DestroyNotify) void;
