...
pub const FileFilter = extern struct {
    ...
    // Constructors
    extern fn gtk_file_filter_new() ?*Self;
    pub const new = gtk_file_filter_new;

    extern fn gtk_file_filter_new_from_gvariant(variant: *glib.Variant) ?*Self;
    ...
    // Methods
    extern fn gtk_file_filter_add_mime_type(self: *Self, mime_type: [*c]const u8) void;
    pub const addMimeType = gtk_file_filter_add_mime_type;

    extern fn gtk_file_filter_add_pattern(self: *Self, pattern: [*c]const u8) void;
    pub const addPattern = gtk_file_filter_add_pattern;

    extern fn gtk_file_filter_add_pixbuf_formats(self: *Self) void;
    pub const addPixbufFormats = gtk_file_filter_add_pixbuf_formats;

    extern fn gtk_file_filter_add_suffix(self: *Self, suffix: [*c]const u8) void;
    ...
    extern fn gtk_file_filter_get_attributes(self: *Self) [*c][*c]const u8;
    pub const getAttributes = gtk_file_filter_get_attributes;

    extern fn g_object_get_data(self: *Self, key: [*c]const u8) ?*anyopaque;
    pub const getData = g_object_get_data;

    extern fn gtk_file_filter_get_name(self: *Self) [*c]const u8;
    ...
    extern fn gtk_file_filter_set_name(self: *Self, name: [*c]const u8) void;
