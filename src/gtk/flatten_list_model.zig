...
pub const FlattenListModel = extern struct {
    ...
    extern fn gtk_flatten_list_model_get_model(self: *Self) ?*gio.ListModel;
    pub const getModel = gtk_flatten_list_model_get_model;

    extern fn gtk_flatten_list_model_get_model_for_item(self: *Self, position: u32) ?*gio.ListModel;
