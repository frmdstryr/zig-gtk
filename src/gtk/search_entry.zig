...
pub const SearchEntry = extern struct {
    ...
    // Constructors
    extern fn gtk_search_entry_new() ?*Self;
    ...
    extern fn gtk_search_entry_get_key_capture_widget(self: *Self) ?*gtk.Widget;
    pub const getKeyCaptureWidget = gtk_search_entry_get_key_capture_widget;
    ...
    extern fn gtk_search_entry_set_key_capture_widget(self: *Self, widget: ?*gtk.Widget) void;
    pub const setKeyCaptureWidget = gtk_search_entry_set_key_capture_widget;
    ...
    pub inline fn connectNextMatch(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, data: ?*T) callconv(.C) void,
        data: ?*T,
        ...
        return c.g_signal_connect_data(self, "next-match", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectNextMatchSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "next-match", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectPreviousMatch(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, data: ?*T) callconv(.C) void,
        data: ?*T,
        ...
        return c.g_signal_connect_data(self, "previous-match", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectPreviousMatchSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "previous-match", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectSearchChanged(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, data: ?*T) callconv(.C) void,
        data: ?*T,
        ...
        return c.g_signal_connect_data(self, "search-changed", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectSearchChangedSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "search-changed", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectSearchStarted(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, data: ?*T) callconv(.C) void,
        data: ?*T,
        ...
        return c.g_signal_connect_data(self, "search-started", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectSearchStartedSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "search-started", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectStopSearch(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, data: ?*T) callconv(.C) void,
        data: ?*T,
        ...
        return c.g_signal_connect_data(self, "stop-search", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectStopSearchSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "stop-search", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
