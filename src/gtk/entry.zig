...
pub const Entry = extern struct {
    ...
    // Constructors
    extern fn gtk_entry_new() ?*Self;
    pub const new = gtk_entry_new;

    extern fn gtk_entry_new_with_buffer(buffer: *gtk.EntryBuffer) ?*Self;
    ...
    extern fn gtk_entry_get_activates_default(self: *Self) bool;
    pub const getActivatesDefault = gtk_entry_get_activates_default;

    extern fn gtk_entry_get_alignment(self: *Self) f32;
    ...
    extern fn gtk_entry_get_attributes(self: *Self) ?*pango.AttrList;
    ...
    extern fn gtk_entry_get_buffer(self: *Self) ?*gtk.EntryBuffer;
    ...
    extern fn gtk_entry_get_completion(self: *Self) ?*gtk.EntryCompletion;
    ...
    extern fn gtk_entry_get_current_icon_drag_source(self: *Self) i32;
    ...
    extern fn gtk_entry_get_extra_menu(self: *Self) ?*gio.MenuModel;
    ...
    extern fn gtk_entry_get_has_frame(self: *Self) bool;
    ...
    extern fn gtk_entry_get_icon_gicon(self: *Self, icon_pos: gtk.EntryIconPosition) ?*gio.Icon;
    pub const getIconGicon = gtk_entry_get_icon_gicon;

    extern fn gtk_entry_get_icon_name(self: *Self, icon_pos: gtk.EntryIconPosition) [*c]const u8;
    pub const getIconName = gtk_entry_get_icon_name;

    extern fn gtk_entry_get_icon_paintable(self: *Self, icon_pos: gtk.EntryIconPosition) ?*gdk.Paintable;
    pub const getIconPaintable = gtk_entry_get_icon_paintable;

    extern fn gtk_entry_get_icon_sensitive(self: *Self, icon_pos: gtk.EntryIconPosition) bool;
    pub const getIconSensitive = gtk_entry_get_icon_sensitive;

    extern fn gtk_entry_get_icon_storage_type(self: *Self, icon_pos: gtk.EntryIconPosition) gtk.ImageType;
    pub const getIconStorageType = gtk_entry_get_icon_storage_type;

    extern fn gtk_entry_get_icon_tooltip_markup(self: *Self, icon_pos: gtk.EntryIconPosition) [*c]const u8;
    pub const getIconTooltipMarkup = gtk_entry_get_icon_tooltip_markup;

    extern fn gtk_entry_get_icon_tooltip_text(self: *Self, icon_pos: gtk.EntryIconPosition) [*c]const u8;
    pub const getIconTooltipText = gtk_entry_get_icon_tooltip_text;

    extern fn gtk_entry_get_input_hints(self: *Self) gtk.InputHints;
    pub const getInputHints = gtk_entry_get_input_hints;

    extern fn gtk_entry_get_input_purpose(self: *Self) gtk.InputPurpose;
    pub const getInputPurpose = gtk_entry_get_input_purpose;

    extern fn gtk_entry_get_invisible_char(self: *Self) u32;
    ...
    extern fn gtk_entry_get_max_length(self: *Self) i32;
    ...
    extern fn gtk_entry_get_overwrite_mode(self: *Self) bool;
    ...
    extern fn gtk_entry_get_placeholder_text(self: *Self) [*c]const u8;
    ...
    extern fn gtk_entry_get_progress_fraction(self: *Self) f64;
    pub const getProgressFraction = gtk_entry_get_progress_fraction;

    extern fn gtk_entry_get_progress_pulse_step(self: *Self) f64;
    ...
    extern fn gtk_entry_get_tabs(self: *Self) ?*pango.TabArray;
    ...
    extern fn gtk_entry_get_text_length(self: *Self) u16;
    ...
    extern fn gtk_entry_get_visibility(self: *Self) bool;
    ...
    extern fn gtk_entry_grab_focus_without_selecting(self: *Self) bool;
    ...
    extern fn gtk_entry_progress_pulse(self: *Self) void;
    ...
    extern fn gtk_entry_reset_im_context(self: *Self) void;
    pub const resetImContext = gtk_entry_reset_im_context;

    extern fn g_object_run_dispose(self: *Self) void;
    pub const runDispose = g_object_run_dispose;

    extern fn gtk_entry_set_activates_default(self: *Self, setting: bool) void;
    pub const setActivatesDefault = gtk_entry_set_activates_default;

    extern fn gtk_entry_set_alignment(self: *Self, xalign: f32) void;
    pub const setAlignment = gtk_entry_set_alignment;

    extern fn gtk_entry_set_attributes(self: *Self, attrs: *pango.AttrList) void;
    pub const setAttributes = gtk_entry_set_attributes;

    extern fn gtk_entry_set_buffer(self: *Self, buffer: *gtk.EntryBuffer) void;
    ...
    extern fn gtk_entry_set_completion(self: *Self, completion: ?*gtk.EntryCompletion) void;
    ...
    extern fn gtk_entry_set_extra_menu(self: *Self, model: ?*gio.MenuModel) void;
    ...
    extern fn gtk_entry_set_has_frame(self: *Self, setting: bool) void;
    ...
    extern fn gtk_entry_set_icon_activatable(self: *Self, icon_pos: gtk.EntryIconPosition, activatable: bool) void;
    pub const setIconActivatable = gtk_entry_set_icon_activatable;

    extern fn gtk_entry_set_icon_drag_source(self: *Self, icon_pos: gtk.EntryIconPosition, provider: *gdk.ContentProvider, actions: gdk.DragAction) void;
    pub const setIconDragSource = gtk_entry_set_icon_drag_source;

    extern fn gtk_entry_set_icon_from_gicon(self: *Self, icon_pos: gtk.EntryIconPosition, icon: ?*gio.Icon) void;
    pub const setIconFromGicon = gtk_entry_set_icon_from_gicon;

    extern fn gtk_entry_set_icon_from_icon_name(self: *Self, icon_pos: gtk.EntryIconPosition, icon_name: [*c]const u8) void;
    pub const setIconFromIconName = gtk_entry_set_icon_from_icon_name;

    extern fn gtk_entry_set_icon_from_paintable(self: *Self, icon_pos: gtk.EntryIconPosition, paintable: ?*gdk.Paintable) void;
    pub const setIconFromPaintable = gtk_entry_set_icon_from_paintable;

    extern fn gtk_entry_set_icon_sensitive(self: *Self, icon_pos: gtk.EntryIconPosition, sensitive: bool) void;
    pub const setIconSensitive = gtk_entry_set_icon_sensitive;

    extern fn gtk_entry_set_icon_tooltip_markup(self: *Self, icon_pos: gtk.EntryIconPosition, tooltip: [*c]const u8) void;
    pub const setIconTooltipMarkup = gtk_entry_set_icon_tooltip_markup;

    extern fn gtk_entry_set_icon_tooltip_text(self: *Self, icon_pos: gtk.EntryIconPosition, tooltip: [*c]const u8) void;
    pub const setIconTooltipText = gtk_entry_set_icon_tooltip_text;

    extern fn gtk_entry_set_input_hints(self: *Self, hints: gtk.InputHints) void;
    pub const setInputHints = gtk_entry_set_input_hints;

    extern fn gtk_entry_set_input_purpose(self: *Self, purpose: gtk.InputPurpose) void;
    pub const setInputPurpose = gtk_entry_set_input_purpose;

    extern fn gtk_entry_set_invisible_char(self: *Self, ch: u32) void;
    ...
    extern fn gtk_entry_set_max_length(self: *Self, max: i32) void;
    ...
    extern fn gtk_entry_set_overwrite_mode(self: *Self, overwrite: bool) void;
    ...
    extern fn gtk_entry_set_placeholder_text(self: *Self, text: [*c]const u8) void;
    pub const setPlaceholderText = gtk_entry_set_placeholder_text;

    extern fn gtk_entry_set_progress_fraction(self: *Self, fraction: f64) void;
    pub const setProgressFraction = gtk_entry_set_progress_fraction;

    extern fn gtk_entry_set_progress_pulse_step(self: *Self, fraction: f64) void;
    ...
    extern fn gtk_entry_set_tabs(self: *Self, tabs: ?*pango.TabArray) void;
    ...
    extern fn gtk_entry_set_visibility(self: *Self, visible: bool) void;
    ...
    extern fn gtk_entry_unset_invisible_char(self: *Self) void;
    ...
    pub inline fn connectIconPress(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, icon_pos: gtk.EntryIconPosition, data: ?*T) callconv(.C) void,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "icon-press", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectIconPressSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, icon_pos: gtk.EntryIconPosition) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "icon-press", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectIconRelease(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, icon_pos: gtk.EntryIconPosition, data: ?*T) callconv(.C) void,
        data: ?*T,
        ...
        return c.g_signal_connect_data(self, "icon-release", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectIconReleaseSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, icon_pos: gtk.EntryIconPosition) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "icon-release", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub const Properties = enum(u8) {
        ...
        input_purpose = 9,
        invisible_char = 10,
        invisible_char_set = 11,
        max_length = 12,
        overwrite_mode = 13,
        placeholder_text = 14,
        primary_icon_activatable = 15,
        primary_icon_gicon = 16,
        primary_icon_name = 17,
        primary_icon_paintable = 18,
        primary_icon_sensitive = 19,
        primary_icon_storage_type = 20,
        primary_icon_tooltip_markup = 21,
        primary_icon_tooltip_text = 22,
        progress_fraction = 23,
        progress_pulse_step = 24,
        scroll_offset = 25,
        secondary_icon_activatable = 26,
        secondary_icon_gicon = 27,
        secondary_icon_name = 28,
        secondary_icon_paintable = 29,
        secondary_icon_sensitive = 30,
        secondary_icon_storage_type = 31,
        secondary_icon_tooltip_markup = 32,
        secondary_icon_tooltip_text = 33,
        show_emoji_icon = 34,
        tabs = 35,
        text_length = 36,
        truncate_multiline = 37,
        visibility = 38,
        can_focus = 39,
        can_target = 40,
        css_classes = 41,
    ...
    pub inline fn asCellEditable(self: *Self) *gtk.CellEditable {
        return @ptrCast(self);
    }
    pub inline fn asEditable(self: *Self) *gtk.Editable {
        return @ptrCast(self);
    }
