...
pub const ShortcutsSection = extern struct {
    const Self = @This();
    ...
    extern fn gtk_box_append(self: *Self, child: *gtk.Widget) void;
    ...
    extern fn gtk_box_get_homogeneous(self: *Self) bool;
    ...
    extern fn gtk_box_get_spacing(self: *Self) i32;
    ...
    extern fn gtk_box_insert_child_after(self: *Self, child: *gtk.Widget, sibling: ?*gtk.Widget) void;
    ...
    extern fn gtk_box_prepend(self: *Self, child: *gtk.Widget) void;
    ...
    extern fn gtk_box_remove(self: *Self, child: *gtk.Widget) void;
    ...
    extern fn gtk_box_reorder_child_after(self: *Self, child: *gtk.Widget, sibling: ?*gtk.Widget) void;
    ...
    extern fn gtk_box_set_homogeneous(self: *Self, homogeneous: bool) void;
    ...
    extern fn gtk_box_set_spacing(self: *Self, spacing: i32) void;
    ...
    pub inline fn asBox(self: *Self) *gtk.Box {
        return @ptrCast(self);
    }
