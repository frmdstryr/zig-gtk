...
pub const LevelBar = extern struct {
    ...
    // Constructors
    extern fn gtk_level_bar_new() ?*Self;
    pub const new = gtk_level_bar_new;

    extern fn gtk_level_bar_new_for_interval(min_value: f64, max_value: f64) ?*Self;
    ...
    extern fn gtk_level_bar_add_offset_value(self: *Self, name: [*c]const u8, value: f64) void;
    ...
    extern fn gtk_level_bar_get_inverted(self: *Self) bool;
    ...
    extern fn gtk_level_bar_get_max_value(self: *Self) f64;
    pub const getMaxValue = gtk_level_bar_get_max_value;

    extern fn gtk_level_bar_get_min_value(self: *Self) f64;
    pub const getMinValue = gtk_level_bar_get_min_value;

    extern fn gtk_level_bar_get_mode(self: *Self) gtk.LevelBarMode;
    ...
    extern fn gtk_level_bar_get_offset_value(self: *Self, name: [*c]const u8, value: *f64) bool;
    ...
    extern fn gtk_level_bar_get_value(self: *Self) f64;
    ...
    extern fn gtk_level_bar_remove_offset_value(self: *Self, name: [*c]const u8) void;
    ...
    extern fn gtk_level_bar_set_inverted(self: *Self, inverted: bool) void;
    ...
    extern fn gtk_level_bar_set_max_value(self: *Self, value: f64) void;
    pub const setMaxValue = gtk_level_bar_set_max_value;

    extern fn gtk_level_bar_set_min_value(self: *Self, value: f64) void;
    pub const setMinValue = gtk_level_bar_set_min_value;

    extern fn gtk_level_bar_set_mode(self: *Self, mode: gtk.LevelBarMode) void;
    ...
    extern fn gtk_level_bar_set_value(self: *Self, value: f64) void;
    ...
    // Signals
    pub inline fn connectOffsetChanged(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, name: [*c]const u8, data: ?*T) callconv(.C) void,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "offset-changed", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectOffsetChangedSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, name: [*c]const u8) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "offset-changed", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
