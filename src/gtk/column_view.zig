...
pub const ColumnView = extern struct {
    ...
    // Constructors
    extern fn gtk_column_view_new(model: ?*gtk.SelectionModel) ?*Self;
    ...
    extern fn gtk_column_view_append_column(self: *Self, column: *gtk.ColumnViewColumn) void;
    ...
    extern fn gtk_column_view_get_enable_rubberband(self: *Self) bool;
    ...
    extern fn gtk_column_view_get_model(self: *Self) ?*gtk.SelectionModel;
    ...
    extern fn gtk_column_view_get_reorderable(self: *Self) bool;
    ...
    extern fn gtk_column_view_get_show_column_separators(self: *Self) bool;
    pub const getShowColumnSeparators = gtk_column_view_get_show_column_separators;

    extern fn gtk_column_view_get_show_row_separators(self: *Self) bool;
    pub const getShowRowSeparators = gtk_column_view_get_show_row_separators;

    extern fn gtk_column_view_get_single_click_activate(self: *Self) bool;
    ...
    extern fn gtk_column_view_get_sorter(self: *Self) ?*gtk.Sorter;
    ...
    extern fn gtk_column_view_insert_column(self: *Self, position: u32, column: *gtk.ColumnViewColumn) void;
    ...
    extern fn gtk_column_view_remove_column(self: *Self, column: *gtk.ColumnViewColumn) void;
    ...
    extern fn gtk_column_view_set_enable_rubberband(self: *Self, enable_rubberband: bool) void;
    ...
    extern fn gtk_column_view_set_model(self: *Self, model: ?*gtk.SelectionModel) void;
    ...
    extern fn gtk_column_view_set_show_column_separators(self: *Self, show_column_separators: bool) void;
    pub const setShowColumnSeparators = gtk_column_view_set_show_column_separators;

    extern fn gtk_column_view_set_show_row_separators(self: *Self, show_row_separators: bool) void;
    pub const setShowRowSeparators = gtk_column_view_set_show_row_separators;

    extern fn gtk_column_view_set_single_click_activate(self: *Self, single_click_activate: bool) void;
    ...
    extern fn gtk_column_view_sort_by_column(self: *Self, column: ?*gtk.ColumnViewColumn, direction: gtk.SortType) void;
