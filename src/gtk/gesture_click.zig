...
pub const GestureClick = extern struct {
    const Self = @This();
    ...
    // Constructors
    extern fn gtk_gesture_click_new() ?*Self;
    ...
    // Signals
    pub inline fn connectPressed(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, n_press: i32, x: f64, y: f64, data: ?*T) callconv(.C) void,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "pressed", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectPressedSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, n_press: i32, x: f64, y: f64) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "pressed", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectReleased(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, n_press: i32, x: f64, y: f64, data: ?*T) callconv(.C) void,
        data: ?*T,
        ...
        return c.g_signal_connect_data(self, "released", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectReleasedSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, n_press: i32, x: f64, y: f64) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "released", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectStopped(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "stopped", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectStoppedSwapped(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "stopped", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectUnpairedRelease(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, x: f64, y: f64, button: u32, sequence: *gdk.EventSequence, data: ?*T) callconv(.C) void,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "unpaired-release", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectUnpairedReleaseSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, x: f64, y: f64, button: u32, sequence: *gdk.EventSequence) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "unpaired-release", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
