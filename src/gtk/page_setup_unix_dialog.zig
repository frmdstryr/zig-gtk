...
// ObjectInfo(PageSetupUnixDialog)
...
pub const PageSetupUnixDialog = extern struct {
    const Self = @This();
    ...
    // Constructors
    extern fn gtk_page_setup_unix_dialog_new(title: [*c]const u8, parent: ?*gtk.Window) ?*Self;
    pub const new = gtk_page_setup_unix_dialog_new;
    ...
    extern fn gtk_page_setup_unix_dialog_get_page_setup(self: *Self) ?*gtk.PageSetup;
    pub const getPageSetup = gtk_page_setup_unix_dialog_get_page_setup;
    ...
    extern fn gtk_page_setup_unix_dialog_get_print_settings(self: *Self) ?*gtk.PrintSettings;
    pub const getPrintSettings = gtk_page_setup_unix_dialog_get_print_settings;
    ...
    extern fn gtk_page_setup_unix_dialog_set_page_setup(self: *Self, page_setup: *gtk.PageSetup) void;
    pub const setPageSetup = gtk_page_setup_unix_dialog_set_page_setup;

    extern fn gtk_widget_set_parent(self: *Self, parent: *gtk.Widget) void;
    pub const setParent = gtk_widget_set_parent;

    extern fn gtk_page_setup_unix_dialog_set_print_settings(self: *Self, print_settings: ?*gtk.PrintSettings) void;
    pub const setPrintSettings = gtk_page_setup_unix_dialog_set_print_settings;
    ...
    pub const Properties = enum(u8) {
        ...
        default_width = 6,
        deletable = 7,
        destroy_with_parent = 8,
        display = 9,
        focus_visible = 10,
        focus_widget = 11,
        fullscreened = 12,
        handle_menubar_accel = 13,
        hide_on_close = 14,
        icon_name = 15,
        is_active = 16,
        maximized = 17,
        mnemonics_visible = 18,
        modal = 19,
        resizable = 20,
        startup_id = 21,
        title = 22,
    ...
    pub inline fn gType() usize {
        return c.gtk_page_setup_unix_dialog_get_type();
    }
};
