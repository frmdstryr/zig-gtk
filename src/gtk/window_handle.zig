...
pub const WindowHandle = extern struct {
    ...
    extern fn gtk_window_handle_get_child(self: *Self) ?*gtk.Widget;
    pub const getChild = gtk_window_handle_get_child;
    ...
    extern fn gtk_window_handle_set_child(self: *Self, child: ?*gtk.Widget) void;
    pub const setChild = gtk_window_handle_set_child;
