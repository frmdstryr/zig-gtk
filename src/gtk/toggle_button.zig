...
pub const ToggleButton = extern struct {
    ...
    extern fn gtk_toggle_button_new_with_label(label: [*c]const u8) ?*Self;
    pub const newWithLabel = gtk_toggle_button_new_with_label;

    extern fn gtk_toggle_button_new_with_mnemonic(label: [*c]const u8) ?*Self;
    ...
    extern fn gtk_toggle_button_get_active(self: *Self) bool;
    ...
    extern fn gtk_toggle_button_set_active(self: *Self, is_active: bool) void;
    ...
    extern fn gtk_toggle_button_set_group(self: *Self, group: ?*gtk.ToggleButton) void;
    pub const setGroup = gtk_toggle_button_set_group;
    ...
    extern fn gtk_toggle_button_toggled(self: *Self) void;
