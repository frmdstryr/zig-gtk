...
pub const ColorDialogButton = extern struct {
    const Self = @This();
    ...
    // Constructors
    extern fn gtk_color_dialog_button_new(dialog: ?*gtk.ColorDialog) ?*Self;
    ...
    extern fn gtk_color_dialog_button_get_dialog(self: *Self) ?*gtk.ColorDialog;
    ...
    extern fn gtk_color_dialog_button_get_rgba(self: *Self) ?*gdk.RGBA;
    ...
    extern fn gtk_color_dialog_button_set_dialog(self: *Self, dialog: *gtk.ColorDialog) void;
    ...
    extern fn gtk_color_dialog_button_set_rgba(self: *Self, color: *gdk.RGBA) void;
    ...
    pub inline fn gType() usize {
        return c.gtk_color_dialog_button_get_type();
    }
};

test "gtk.ColorDialogButton" {
