...
pub const CallbackAction = extern struct {
    ...
    // Constructors
    extern fn gtk_callback_action_new(callback: ?*const fn (widget: *gtk.Widget, args: ?*glib.Variant, user_data: ?*anyopaque) callconv(.C) bool, data: ?*anyopaque, destroy: *const fn (data: ?*anyopaque) callconv(.C) void) ?*Self;
    ...
    pub inline fn gType() usize {
        return c.gtk_callback_action_get_type();
    }
};
