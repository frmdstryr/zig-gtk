...
pub const AspectFrame = extern struct {
    ...
    extern fn gtk_aspect_frame_get_child(self: *Self) ?*gtk.Widget;
    ...
    extern fn gtk_aspect_frame_get_obey_child(self: *Self) bool;
    ...
    extern fn gtk_aspect_frame_get_ratio(self: *Self) f32;
    ...
    extern fn gtk_aspect_frame_get_xalign(self: *Self) f32;
    pub const getXalign = gtk_aspect_frame_get_xalign;

    extern fn gtk_aspect_frame_get_yalign(self: *Self) f32;
    ...
    extern fn gtk_aspect_frame_set_child(self: *Self, child: ?*gtk.Widget) void;
    ...
    extern fn gtk_aspect_frame_set_obey_child(self: *Self, obey_child: bool) void;
    ...
    extern fn gtk_aspect_frame_set_ratio(self: *Self, ratio: f32) void;
    ...
    extern fn gtk_aspect_frame_set_xalign(self: *Self, xalign: f32) void;
    pub const setXalign = gtk_aspect_frame_set_xalign;

    extern fn gtk_aspect_frame_set_yalign(self: *Self, yalign: f32) void;
