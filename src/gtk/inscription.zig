...
pub const Inscription = extern struct {
    const Self = @This();
    ...
    // Constructors
    extern fn gtk_inscription_new(text: [*c]const u8) ?*Self;
    pub const new = gtk_inscription_new;
    ...
    extern fn gtk_inscription_get_attributes(self: *Self) ?*pango.AttrList;
    pub const getAttributes = gtk_inscription_get_attributes;
    ...
    extern fn gtk_inscription_get_min_chars(self: *Self) u32;
    pub const getMinChars = gtk_inscription_get_min_chars;

    extern fn gtk_inscription_get_min_lines(self: *Self) u32;
    pub const getMinLines = gtk_inscription_get_min_lines;

    extern fn gtk_widget_get_name(self: *Self) [*c]const u8;
    pub const getName = gtk_widget_get_name;

    extern fn gtk_inscription_get_nat_chars(self: *Self) u32;
    pub const getNatChars = gtk_inscription_get_nat_chars;

    extern fn gtk_inscription_get_nat_lines(self: *Self) u32;
    pub const getNatLines = gtk_inscription_get_nat_lines;
    ...
    extern fn gtk_inscription_get_text(self: *Self) [*c]const u8;
    pub const getText = gtk_inscription_get_text;

    extern fn gtk_inscription_get_text_overflow(self: *Self) gtk.InscriptionOverflow;
    pub const getTextOverflow = gtk_inscription_get_text_overflow;
    ...
    extern fn gtk_inscription_get_wrap_mode(self: *Self) pango.WrapMode;
    pub const getWrapMode = gtk_inscription_get_wrap_mode;

    extern fn gtk_inscription_get_xalign(self: *Self) f32;
    pub const getXalign = gtk_inscription_get_xalign;

    extern fn gtk_inscription_get_yalign(self: *Self) f32;
    pub const getYalign = gtk_inscription_get_yalign;
    ...
    extern fn gtk_inscription_set_attributes(self: *Self, attrs: ?*pango.AttrList) void;
    pub const setAttributes = gtk_inscription_set_attributes;
    ...
    extern fn gtk_inscription_set_markup(self: *Self, markup: [*c]const u8) void;
    pub const setMarkup = gtk_inscription_set_markup;

    extern fn gtk_inscription_set_min_chars(self: *Self, min_chars: u32) void;
    pub const setMinChars = gtk_inscription_set_min_chars;

    extern fn gtk_inscription_set_min_lines(self: *Self, min_lines: u32) void;
    pub const setMinLines = gtk_inscription_set_min_lines;

    extern fn gtk_widget_set_name(self: *Self, name: [*c]const u8) void;
    pub const setName = gtk_widget_set_name;

    extern fn gtk_inscription_set_nat_chars(self: *Self, nat_chars: u32) void;
    pub const setNatChars = gtk_inscription_set_nat_chars;

    extern fn gtk_inscription_set_nat_lines(self: *Self, nat_lines: u32) void;
    pub const setNatLines = gtk_inscription_set_nat_lines;
    ...
    extern fn gtk_inscription_set_text(self: *Self, text: [*c]const u8) void;
    pub const setText = gtk_inscription_set_text;

    extern fn gtk_inscription_set_text_overflow(self: *Self, overflow: gtk.InscriptionOverflow) void;
    pub const setTextOverflow = gtk_inscription_set_text_overflow;
    ...
    extern fn gtk_inscription_set_wrap_mode(self: *Self, wrap_mode: pango.WrapMode) void;
    pub const setWrapMode = gtk_inscription_set_wrap_mode;

    extern fn gtk_inscription_set_xalign(self: *Self, xalign: f32) void;
    pub const setXalign = gtk_inscription_set_xalign;

    extern fn gtk_inscription_set_yalign(self: *Self, yalign: f32) void;
    pub const setYalign = gtk_inscription_set_yalign;
    ...
    pub inline fn gType() usize {
        return c.gtk_inscription_get_type();
    }
};

test "gtk.Inscription" {
