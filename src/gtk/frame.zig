...
pub const Frame = extern struct {
    ...
    // Constructors
    extern fn gtk_frame_new(label: [*c]const u8) ?*Self;
    ...
    extern fn gtk_frame_get_child(self: *Self) ?*gtk.Widget;
    ...
    extern fn gtk_frame_get_label(self: *Self) [*c]const u8;
    pub const getLabel = gtk_frame_get_label;

    extern fn gtk_frame_get_label_align(self: *Self) f32;
    pub const getLabelAlign = gtk_frame_get_label_align;

    extern fn gtk_frame_get_label_widget(self: *Self) ?*gtk.Widget;
    ...
    extern fn gtk_frame_set_child(self: *Self, child: ?*gtk.Widget) void;
    ...
    extern fn gtk_frame_set_label(self: *Self, label: [*c]const u8) void;
    pub const setLabel = gtk_frame_set_label;

    extern fn gtk_frame_set_label_align(self: *Self, xalign: f32) void;
    pub const setLabelAlign = gtk_frame_set_label_align;

    extern fn gtk_frame_set_label_widget(self: *Self, label_widget: ?*gtk.Widget) void;
