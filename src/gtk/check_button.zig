...
pub const CheckButton = extern struct {
    ...
    // Constructors
    extern fn gtk_check_button_new() ?*Self;
    pub const new = gtk_check_button_new;

    extern fn gtk_check_button_new_with_label(label: [*c]const u8) ?*Self;
    pub const newWithLabel = gtk_check_button_new_with_label;

    extern fn gtk_check_button_new_with_mnemonic(label: [*c]const u8) ?*Self;
    ...
    extern fn gtk_check_button_get_active(self: *Self) bool;
    ...
    extern fn gtk_check_button_get_child(self: *Self) ?*gtk.Widget;
    ...
    extern fn gtk_check_button_get_inconsistent(self: *Self) bool;
    pub const getInconsistent = gtk_check_button_get_inconsistent;

    extern fn gtk_check_button_get_label(self: *Self) [*c]const u8;
    ...
    extern fn gtk_check_button_get_use_underline(self: *Self) bool;
    ...
    extern fn gtk_check_button_set_active(self: *Self, setting: bool) void;
    ...
    extern fn gtk_check_button_set_child(self: *Self, child: ?*gtk.Widget) void;
    ...
    extern fn gtk_check_button_set_group(self: *Self, group: ?*gtk.CheckButton) void;
    ...
    extern fn gtk_check_button_set_inconsistent(self: *Self, inconsistent: bool) void;
    pub const setInconsistent = gtk_check_button_set_inconsistent;

    extern fn gtk_check_button_set_label(self: *Self, label: [*c]const u8) void;
    ...
    extern fn gtk_check_button_set_use_underline(self: *Self, setting: bool) void;
    ...
    pub inline fn connectToggled(
        ...
        return c.g_signal_connect_data(self, "toggled", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectToggledSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "toggled", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
