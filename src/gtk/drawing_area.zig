...
pub const DrawingArea = extern struct {
    ...
    // Constructors
    extern fn gtk_drawing_area_new() ?*Self;
    ...
    extern fn gtk_drawing_area_get_content_height(self: *Self) i32;
    pub const getContentHeight = gtk_drawing_area_get_content_height;

    extern fn gtk_drawing_area_get_content_width(self: *Self) i32;
    ...
    extern fn gtk_drawing_area_set_content_height(self: *Self, height: i32) void;
    pub const setContentHeight = gtk_drawing_area_set_content_height;

    extern fn gtk_drawing_area_set_content_width(self: *Self, width: i32) void;
    ...
    extern fn gtk_drawing_area_set_draw_func(self: *Self, draw_func: ?*const fn (drawing_area: *gtk.DrawingArea, cr: *cairo.Context, width: i32, height: i32, user_data: ?*anyopaque) callconv(.C) void, user_data: ?*anyopaque, destroy: *const fn (data: ?*anyopaque) callconv(.C) void) void;
