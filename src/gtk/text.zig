...
pub const Text = extern struct {
    ...
    // Constructors
    extern fn gtk_text_new() ?*Self;
    pub const new = gtk_text_new;

    extern fn gtk_text_new_with_buffer(buffer: *gtk.EntryBuffer) ?*Self;
    pub const newWithBuffer = gtk_text_new_with_buffer;
    ...
    extern fn gtk_text_compute_cursor_extents(self: *Self, position: u64, strong: *graphene.Rect, weak: *graphene.Rect) void;
    pub const computeCursorExtents = gtk_text_compute_cursor_extents;
    ...
    extern fn gtk_text_get_activates_default(self: *Self) bool;
    pub const getActivatesDefault = gtk_text_get_activates_default;
    ...
    extern fn gtk_text_get_enable_emoji_completion(self: *Self) bool;
    pub const getEnableEmojiCompletion = gtk_text_get_enable_emoji_completion;

    extern fn gtk_text_get_extra_menu(self: *Self) ?*gio.MenuModel;
    pub const getExtraMenu = gtk_text_get_extra_menu;
    ...
    extern fn gtk_text_get_input_hints(self: *Self) gtk.InputHints;
    pub const getInputHints = gtk_text_get_input_hints;

    extern fn gtk_text_get_input_purpose(self: *Self) gtk.InputPurpose;
    pub const getInputPurpose = gtk_text_get_input_purpose;

    extern fn gtk_text_get_invisible_char(self: *Self) u32;
    pub const getInvisibleChar = gtk_text_get_invisible_char;
    ...
    extern fn gtk_text_get_max_length(self: *Self) i32;
    pub const getMaxLength = gtk_text_get_max_length;
    ...
    extern fn gtk_text_get_overwrite_mode(self: *Self) bool;
    pub const getOverwriteMode = gtk_text_get_overwrite_mode;
    ...
    extern fn gtk_text_get_placeholder_text(self: *Self) [*c]const u8;
    pub const getPlaceholderText = gtk_text_get_placeholder_text;
    ...
    extern fn gtk_text_get_propagate_text_width(self: *Self) bool;
    pub const getPropagateTextWidth = gtk_text_get_propagate_text_width;
    ...
    extern fn gtk_text_get_tabs(self: *Self) ?*pango.TabArray;
    pub const getTabs = gtk_text_get_tabs;
    ...
    extern fn gtk_text_get_text_length(self: *Self) u16;
    pub const getTextLength = gtk_text_get_text_length;
    ...
    extern fn gtk_text_get_truncate_multiline(self: *Self) bool;
    pub const getTruncateMultiline = gtk_text_get_truncate_multiline;
    ...
    extern fn gtk_text_get_visibility(self: *Self) bool;
    pub const getVisibility = gtk_text_get_visibility;
    ...
    extern fn gtk_text_grab_focus_without_selecting(self: *Self) bool;
    pub const grabFocusWithoutSelecting = gtk_text_grab_focus_without_selecting;
    ...
    extern fn gtk_text_set_activates_default(self: *Self, activates: bool) void;
    pub const setActivatesDefault = gtk_text_set_activates_default;

    extern fn gtk_text_set_attributes(self: *Self, attrs: ?*pango.AttrList) void;
    pub const setAttributes = gtk_text_set_attributes;

    extern fn gtk_text_set_buffer(self: *Self, buffer: *gtk.EntryBuffer) void;
    pub const setBuffer = gtk_text_set_buffer;
    ...
    extern fn gtk_text_set_enable_emoji_completion(self: *Self, enable_emoji_completion: bool) void;
    pub const setEnableEmojiCompletion = gtk_text_set_enable_emoji_completion;

    extern fn gtk_text_set_extra_menu(self: *Self, model: ?*gio.MenuModel) void;
    pub const setExtraMenu = gtk_text_set_extra_menu;
    ...
    extern fn gtk_text_set_input_hints(self: *Self, hints: gtk.InputHints) void;
    pub const setInputHints = gtk_text_set_input_hints;

    extern fn gtk_text_set_input_purpose(self: *Self, purpose: gtk.InputPurpose) void;
    pub const setInputPurpose = gtk_text_set_input_purpose;

    extern fn gtk_text_set_invisible_char(self: *Self, ch: u32) void;
    pub const setInvisibleChar = gtk_text_set_invisible_char;
    ...
    extern fn gtk_text_set_max_length(self: *Self, length: i32) void;
    pub const setMaxLength = gtk_text_set_max_length;
    ...
    extern fn gtk_text_set_overwrite_mode(self: *Self, overwrite: bool) void;
    pub const setOverwriteMode = gtk_text_set_overwrite_mode;

    extern fn gtk_widget_set_parent(self: *Self, parent: *gtk.Widget) void;
    pub const setParent = gtk_widget_set_parent;

    extern fn gtk_text_set_placeholder_text(self: *Self, text: [*c]const u8) void;
    pub const setPlaceholderText = gtk_text_set_placeholder_text;

    extern fn gtk_text_set_propagate_text_width(self: *Self, propagate_text_width: bool) void;
    pub const setPropagateTextWidth = gtk_text_set_propagate_text_width;
    ...
    extern fn gtk_text_set_tabs(self: *Self, tabs: ?*pango.TabArray) void;
    pub const setTabs = gtk_text_set_tabs;
    ...
    extern fn gtk_text_set_truncate_multiline(self: *Self, truncate_multiline: bool) void;
    pub const setTruncateMultiline = gtk_text_set_truncate_multiline;
    ...
    extern fn gtk_text_set_visibility(self: *Self, visible: bool) void;
    pub const setVisibility = gtk_text_set_visibility;
    ...
    extern fn gtk_text_unset_invisible_char(self: *Self) void;
    pub const unsetInvisibleChar = gtk_text_unset_invisible_char;
    ...
    pub inline fn connectMoveCursor(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, step: gtk.MovementStep, count: i32, extend: bool, data: ?*T) callconv(.C) void,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
    ...
    pub inline fn connectMoveCursorSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, step: gtk.MovementStep, count: i32, extend: bool) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
    ...
    pub const Properties = enum(u8) {
        ...
        attributes = 1,
        buffer = 2,
        enable_emoji_completion = 3,
        extra_menu = 4,
        im_module = 5,
        input_hints = 6,
        input_purpose = 7,
        invisible_char = 8,
        invisible_char_set = 9,
        max_length = 10,
        overwrite_mode = 11,
        placeholder_text = 12,
        propagate_text_width = 13,
        scroll_offset = 14,
        tabs = 15,
        truncate_multiline = 16,
        visibility = 17,
        can_focus = 18,
        can_target = 19,
        css_classes = 20,
