...
pub const CellRendererText = extern struct {
    ...
    // Constructors
    extern fn gtk_cell_renderer_text_new() ?*Self;
    ...
    pub const Properties = enum(u8) {
        ...
        wrap_width = 45,
        cell_background = 46,
        cell_background_rgba = 47,
        cell_background_set = 48,
        editing = 49,
        height = 50,
        is_expanded = 51,
        is_expander = 52,
