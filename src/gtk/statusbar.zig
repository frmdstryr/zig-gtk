...
pub const Statusbar = extern struct {
    ...
    // Constructors
    extern fn gtk_statusbar_new() ?*Self;
    ...
    extern fn gtk_statusbar_get_context_id(self: *Self, context_description: [*c]const u8) u32;
    ...
    extern fn gtk_statusbar_pop(self: *Self, context_id: u32) void;
    pub const pop = gtk_statusbar_pop;

    extern fn gtk_statusbar_push(self: *Self, context_id: u32, text: [*c]const u8) u32;
    ...
    extern fn gtk_statusbar_remove(self: *Self, context_id: u32, message_id: u32) void;
    pub const remove = gtk_statusbar_remove;

    extern fn gtk_statusbar_remove_all(self: *Self, context_id: u32) void;
    ...
    // Signals
    pub inline fn connectTextPopped(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, context_id: u32, text: [*c]const u8, data: ?*T) callconv(.C) void,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "text-popped", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectTextPoppedSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, context_id: u32, text: [*c]const u8) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "text-popped", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectTextPushed(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, context_id: u32, text: [*c]const u8, data: ?*T) callconv(.C) void,
        data: ?*T,
        ...
        return c.g_signal_connect_data(self, "text-pushed", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectTextPushedSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, context_id: u32, text: [*c]const u8) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "text-pushed", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
