...
pub const ShortcutLabel = extern struct {
    const Self = @This();
    ...
    // Constructors
    extern fn gtk_shortcut_label_new(accelerator: [*c]const u8) ?*Self;
    ...
    extern fn gtk_shortcut_label_get_accelerator(self: *Self) [*c]const u8;
    ...
    extern fn gtk_shortcut_label_get_disabled_text(self: *Self) [*c]const u8;
    ...
    extern fn gtk_shortcut_label_set_accelerator(self: *Self, accelerator: [*c]const u8) void;
    ...
    extern fn gtk_shortcut_label_set_disabled_text(self: *Self, disabled_text: [*c]const u8) void;
