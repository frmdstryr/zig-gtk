...
pub const MenuButton = extern struct {
    ...
    extern fn gtk_menu_button_set_create_popup_func(self: *Self, func: gtk.MenuButtonCreatePopupFunc, user_data: ?*anyopaque, destroy_notify: glib.DestroyNotify) void;
