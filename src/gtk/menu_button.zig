...
pub const MenuButton = extern struct {
    ...
    // Constructors
    extern fn gtk_menu_button_new() ?*Self;
    ...
    extern fn gtk_menu_button_get_always_show_arrow(self: *Self) bool;
    pub const getAlwaysShowArrow = gtk_menu_button_get_always_show_arrow;
    ...
    extern fn gtk_menu_button_get_child(self: *Self) ?*gtk.Widget;
    pub const getChild = gtk_menu_button_get_child;
    ...
    extern fn gtk_menu_button_get_direction(self: *Self) gtk.ArrowType;
    ...
    extern fn gtk_menu_button_get_has_frame(self: *Self) bool;
    pub const getHasFrame = gtk_menu_button_get_has_frame;
    ...
    extern fn gtk_menu_button_get_icon_name(self: *Self) [*c]const u8;
    pub const getIconName = gtk_menu_button_get_icon_name;

    extern fn gtk_menu_button_get_label(self: *Self) [*c]const u8;
    pub const getLabel = gtk_menu_button_get_label;
    ...
    extern fn gtk_menu_button_get_menu_model(self: *Self) ?*gio.MenuModel;
    ...
    extern fn gtk_menu_button_get_popover(self: *Self) ?*gtk.Popover;
    ...
    extern fn gtk_menu_button_get_primary(self: *Self) bool;
    pub const getPrimary = gtk_menu_button_get_primary;
    ...
    extern fn gtk_menu_button_get_use_underline(self: *Self) bool;
    pub const getUseUnderline = gtk_menu_button_get_use_underline;
    ...
    extern fn gtk_menu_button_popdown(self: *Self) void;
    pub const popdown = gtk_menu_button_popdown;

    extern fn gtk_menu_button_popup(self: *Self) void;
    pub const popup = gtk_menu_button_popup;
    ...
    extern fn gtk_menu_button_set_child(self: *Self, child: ?*gtk.Widget) void;
    pub const setChild = gtk_menu_button_set_child;
    ...
    extern fn gtk_menu_button_set_create_popup_func(self: *Self, func: ?*const fn (menu_button: *gtk.MenuButton, user_data: ?*anyopaque) callconv(.C) void, user_data: ?*anyopaque, destroy_notify: ?*const fn (data: ?*anyopaque) callconv(.C) void) void;
    pub const setCreatePopupFunc = gtk_menu_button_set_create_popup_func;
    ...
    extern fn gtk_menu_button_set_direction(self: *Self, direction: gtk.ArrowType) void;
    ...
    extern fn gtk_menu_button_set_has_frame(self: *Self, has_frame: bool) void;
    pub const setHasFrame = gtk_menu_button_set_has_frame;
    ...
    extern fn gtk_menu_button_set_icon_name(self: *Self, icon_name: [*c]const u8) void;
    pub const setIconName = gtk_menu_button_set_icon_name;

    extern fn gtk_menu_button_set_label(self: *Self, label: [*c]const u8) void;
    pub const setLabel = gtk_menu_button_set_label;
    ...
    extern fn gtk_menu_button_set_menu_model(self: *Self, menu_model: ?*gio.MenuModel) void;
    ...
    extern fn gtk_menu_button_set_popover(self: *Self, popover: ?*gtk.Widget) void;
    pub const setPopover = gtk_menu_button_set_popover;

    extern fn gtk_menu_button_set_primary(self: *Self, primary: bool) void;
    pub const setPrimary = gtk_menu_button_set_primary;
    ...
    extern fn gtk_menu_button_set_use_underline(self: *Self, use_underline: bool) void;
    pub const setUseUnderline = gtk_menu_button_set_use_underline;
