...
pub const EventControllerKey = extern struct {
    const Self = @This();
    ...
    // Constructors
    extern fn gtk_event_controller_key_new() ?*Self;
    ...
    extern fn gtk_event_controller_key_forward(self: *Self, widget: *gtk.Widget) bool;
    ...
    extern fn gtk_event_controller_key_get_group(self: *Self) u32;
    pub const getGroup = gtk_event_controller_key_get_group;

    extern fn gtk_event_controller_key_get_im_context(self: *Self) ?*gtk.IMContext;
    ...
    pub inline fn connectImUpdate(
        ...
        return c.g_signal_connect_data(self, "im-update", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectImUpdateSwapped(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "im-update", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn connectKeyPressed(
        ...
        return c.g_signal_connect_data(self, "key-pressed", @ptrCast(callback), data, null, @intFromEnum(flags));
    }
    ...
    pub inline fn connectKeyPressedSwapped(
        ...
        return c.g_signal_connect_data(self, "key-pressed", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn connectKeyReleased(
        ...
        return c.g_signal_connect_data(self, "key-released", @ptrCast(callback), data, null, @intFromEnum(flags));
    }
    ...
    pub inline fn connectKeyReleasedSwapped(
        ...
        return c.g_signal_connect_data(self, "key-released", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectModifiers(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, state: gdk.ModifierType, data: ?*T) callconv(.C) void,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "modifiers", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectModifiersSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, state: gdk.ModifierType) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "modifiers", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
