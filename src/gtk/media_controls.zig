...
pub const MediaControls = extern struct {
    const Self = @This();
    ...
    // Constructors
    extern fn gtk_media_controls_new(stream: ?*gtk.MediaStream) ?*Self;
    pub const new = gtk_media_controls_new;
    ...
    extern fn gtk_media_controls_get_media_stream(self: *Self) ?*gtk.MediaStream;
    pub const getMediaStream = gtk_media_controls_get_media_stream;
    ...
    extern fn gtk_media_controls_set_media_stream(self: *Self, stream: ?*gtk.MediaStream) void;
    pub const setMediaStream = gtk_media_controls_set_media_stream;
