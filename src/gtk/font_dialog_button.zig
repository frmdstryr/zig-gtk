...
pub const FontDialogButton = extern struct {
    const Self = @This();
    ...
    // Constructors
    extern fn gtk_font_dialog_button_new(dialog: ?*gtk.FontDialog) ?*Self;
    ...
    extern fn gtk_font_dialog_button_get_dialog(self: *Self) ?*gtk.FontDialog;
    ...
    extern fn gtk_font_dialog_button_get_font_desc(self: *Self) ?*pango.FontDescription;
    pub const getFontDesc = gtk_font_dialog_button_get_font_desc;

    extern fn gtk_font_dialog_button_get_font_features(self: *Self) [*c]const u8;
    ...
    extern fn gtk_font_dialog_button_get_language(self: *Self) ?*pango.Language;
    ...
    extern fn gtk_font_dialog_button_get_level(self: *Self) gtk.FontLevel;
    ...
    extern fn gtk_font_dialog_button_get_use_font(self: *Self) bool;
    pub const getUseFont = gtk_font_dialog_button_get_use_font;

    extern fn gtk_font_dialog_button_get_use_size(self: *Self) bool;
    ...
    extern fn gtk_font_dialog_button_set_dialog(self: *Self, dialog: *gtk.FontDialog) void;
    ...
    extern fn gtk_font_dialog_button_set_font_desc(self: *Self, font_desc: *pango.FontDescription) void;
    pub const setFontDesc = gtk_font_dialog_button_set_font_desc;

    extern fn gtk_font_dialog_button_set_font_features(self: *Self, font_features: [*c]const u8) void;
    ...
    extern fn gtk_font_dialog_button_set_language(self: *Self, language: ?*pango.Language) void;
    ...
    extern fn gtk_font_dialog_button_set_level(self: *Self, level: gtk.FontLevel) void;
    ...
    extern fn gtk_font_dialog_button_set_use_font(self: *Self, use_font: bool) void;
    pub const setUseFont = gtk_font_dialog_button_set_use_font;

    extern fn gtk_font_dialog_button_set_use_size(self: *Self, use_size: bool) void;
    ...
    pub inline fn gType() usize {
        return c.gtk_font_dialog_button_get_type();
    }
};

test "gtk.FontDialogButton" {
