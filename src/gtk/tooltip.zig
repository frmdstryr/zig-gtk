...
pub const Tooltip = extern struct {
    ...
    extern fn gtk_tooltip_set_markup(self: *Self, markup: [*c]const u8) void;
    pub const setMarkup = gtk_tooltip_set_markup;

    extern fn g_object_set_property(self: *Self, property_name: [*c]const u8, value: *gobject.Value) void;
    pub const setProperty = g_object_set_property;

    extern fn gtk_tooltip_set_text(self: *Self, text: [*c]const u8) void;
    pub const setText = gtk_tooltip_set_text;

    extern fn gtk_tooltip_set_tip_area(self: *Self, rect: *gdk.Rectangle) void;
