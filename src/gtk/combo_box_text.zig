...
pub const ComboBoxText = extern struct {
    ...
    extern fn gtk_combo_box_text_new_with_entry() ?*Self;
    pub const newWithEntry = gtk_combo_box_text_new_with_entry;

    extern fn gtk_combo_box_new_with_model(model: *gtk.TreeModel) ?*Self;
    pub const newWithModel = gtk_combo_box_new_with_model;

    extern fn gtk_combo_box_new_with_model_and_entry(model: *gtk.TreeModel) ?*Self;
    ...
    extern fn gtk_combo_box_text_append(self: *Self, id: [*c]const u8, text: [*c]const u8) void;
    ...
    extern fn gtk_combo_box_get_entry_text_column(self: *Self) i32;
    ...
    extern fn gtk_combo_box_get_has_entry(self: *Self) bool;
    ...
    extern fn gtk_combo_box_get_id_column(self: *Self) i32;
    ...
    extern fn gtk_combo_box_get_model(self: *Self) ?*gtk.TreeModel;
    ...
    extern fn gtk_combo_box_text_insert(self: *Self, position: i32, id: [*c]const u8, text: [*c]const u8) void;
    ...
    extern fn gtk_combo_box_popdown(self: *Self) void;
    pub const popdown = gtk_combo_box_popdown;

    extern fn gtk_combo_box_popup(self: *Self) void;
    pub const popup = gtk_combo_box_popup;

    extern fn gtk_combo_box_popup_for_device(self: *Self, device: *gdk.Device) void;
    pub const popupForDevice = gtk_combo_box_popup_for_device;

    extern fn gtk_combo_box_text_prepend(self: *Self, id: [*c]const u8, text: [*c]const u8) void;
    ...
    extern fn gtk_combo_box_text_remove_all(self: *Self) void;
    ...
    extern fn gtk_combo_box_set_active_id(self: *Self, active_id: [*c]const u8) bool;
    pub const setActiveId = gtk_combo_box_set_active_id;

    extern fn gtk_combo_box_set_active_iter(self: *Self, iter: ?*gtk.TreeIter) void;
    pub const setActiveIter = gtk_combo_box_set_active_iter;

    extern fn gtk_combo_box_set_button_sensitivity(self: *Self, sensitivity: gtk.SensitivityType) void;
    ...
    extern fn gtk_combo_box_set_entry_text_column(self: *Self, text_column: i32) void;
    ...
    extern fn gtk_combo_box_set_id_column(self: *Self, id_column: i32) void;
    ...
    extern fn gtk_combo_box_set_model(self: *Self, model: ?*gtk.TreeModel) void;
    ...
    pub inline fn connectFormatEntryText(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, path: [*c]const u8, data: ?*T) callconv(.C) [*c]const u8,
        data: ?*T,
        flags: gobject.ConnectFlags
    ) u64 {
        return c.g_signal_connect_data(self, "format-entry-text", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectFormatEntryTextSwapped(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "format-entry-text", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectMoveActive(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "move-active", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectMoveActiveSwapped(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "move-active", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectPopdown(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "popdown", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectPopdownSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "popdown", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }

    pub inline fn connectPopup(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, data: ?*T) callconv(.C) void,
        data: ?*T,
        ...
        return c.g_signal_connect_data(self, "popup", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectPopupSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T) callconv(.C) void,
        data: *T,
        ...
        return c.g_signal_connect_data(self, "popup", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
    ...
    pub inline fn asComboBox(self: *Self) *gtk.ComboBox {
        return @ptrCast(self);
    }
