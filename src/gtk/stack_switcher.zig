...
pub const StackSwitcher = extern struct {
    ...
    // Constructors
    extern fn gtk_stack_switcher_new() ?*Self;
    ...
    extern fn gtk_stack_switcher_get_stack(self: *Self) ?*gtk.Stack;
    ...
    extern fn gtk_stack_switcher_set_stack(self: *Self, stack: ?*gtk.Stack) void;
