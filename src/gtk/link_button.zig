...
pub const LinkButton = extern struct {
    ...
    // Constructors
    extern fn gtk_link_button_new(uri: [*c]const u8) ?*Self;
    ...
    extern fn gtk_link_button_new_with_label(uri: [*c]const u8, label: [*c]const u8) ?*Self;
    ...
    extern fn gtk_link_button_get_uri(self: *Self) [*c]const u8;
    ...
    extern fn gtk_link_button_get_visited(self: *Self) bool;
    ...
    extern fn gtk_link_button_set_uri(self: *Self, uri: [*c]const u8) void;
    ...
    extern fn gtk_link_button_set_visited(self: *Self, visited: bool) void;
