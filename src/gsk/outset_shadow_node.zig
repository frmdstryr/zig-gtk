...
pub const OutsetShadowNode = extern struct {
    const Self = @This();

    // Fields

    // Constructors
    extern fn gsk_outset_shadow_node_new(outline: *gsk.RoundedRect, color: *gdk.RGBA, dx: f32, dy: f32, spread: f32, blur_radius: f32) ?*Self;
    ...
    extern fn gsk_outset_shadow_node_get_dx(self: *Self) f32;
    pub const getDx = gsk_outset_shadow_node_get_dx;

    extern fn gsk_outset_shadow_node_get_dy(self: *Self) f32;
    ...
    extern fn gsk_outset_shadow_node_get_outline(self: *Self) ?*gsk.RoundedRect;
    pub const getOutline = gsk_outset_shadow_node_get_outline;

    extern fn gsk_outset_shadow_node_get_spread(self: *Self) f32;
    ...
    pub inline fn gType() usize {
        return c.gsk_outset_shadow_node_get_type();
    }
};

test "gsk.OutsetShadowNode" {
