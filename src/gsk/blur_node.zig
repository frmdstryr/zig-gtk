...
pub const BlurNode = extern struct {
    const Self = @This();

    // Fields

    // Constructors
    extern fn gsk_blur_node_new(child: *gsk.RenderNode, radius: f32) ?*Self;
    ...
    extern fn gsk_blur_node_get_child(self: *Self) ?*gsk.RenderNode;
    ...
    extern fn gsk_blur_node_get_radius(self: *Self) f32;
