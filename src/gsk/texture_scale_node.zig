...
pub const TextureScaleNode = extern struct {
    const Self = @This();

    // Fields

    // Constructors
    extern fn gsk_texture_scale_node_new(texture: *gdk.Texture, bounds: *graphene.Rect, filter: gsk.ScalingFilter) ?*Self;
    ...
    extern fn gsk_texture_scale_node_get_filter(self: *Self) gsk.ScalingFilter;
    ...
    extern fn gsk_texture_scale_node_get_texture(self: *Self) ?*gdk.Texture;
    ...
    pub inline fn gType() usize {
        return c.gsk_texture_scale_node_get_type();
    }
};

test "gsk.TextureScaleNode" {
