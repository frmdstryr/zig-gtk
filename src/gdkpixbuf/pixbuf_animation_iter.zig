...
// ObjectInfo(PixbufAnimationIter)
...
pub const PixbufAnimationIter = extern struct {
    ...
    extern fn gdk_pixbuf_animation_iter_get_delay_time(self: *Self) i32;
    pub const getDelayTime = gdk_pixbuf_animation_iter_get_delay_time;

    extern fn gdk_pixbuf_animation_iter_get_pixbuf(self: *Self) ?*gdkpixbuf.Pixbuf;
    ...
    extern fn gdk_pixbuf_animation_iter_on_currently_loading_frame(self: *Self) bool;
    ...
    pub inline fn gType() usize {
        return c.gdkpixbuf_pixbuf_animation_iter_get_type();
    }
};

test "gdkpixbuf.PixbufAnimationIter" {
