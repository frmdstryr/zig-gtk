...
pub const PixbufNonAnim = extern struct {
    const Self = @This();
    ...
    extern fn gdk_pixbuf_animation_new_from_stream_async(stream: *gio.InputStream, cancellable: ?*gio.Cancellable, callback: ?*const fn (source_object: ?*gobject.Object, res: *gio.AsyncResult, user_data: ?*anyopaque) callconv(.C) void, user_data: ?*anyopaque) void;
    ...
    pub inline fn gType() usize {
        return c.gdkpixbuf_pixbuf_non_anim_get_type();
    }
};

test "gdkpixbuf.PixbufNonAnim" {
