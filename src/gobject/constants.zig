...
pub const TYPE_BOOLEAN = c.G_TYPE_BOOLEAN;
pub const TYPE_BOXED = c.G_TYPE_BOXED;
pub const TYPE_CHAR = c.G_TYPE_CHAR;
pub const TYPE_DOUBLE = c.G_TYPE_DOUBLE;
pub const TYPE_ENUM = c.G_TYPE_ENUM;
pub const TYPE_FLAGS = c.G_TYPE_FLAGS;
pub const TYPE_FLAG_RESERVED_ID_BIT = c.G_TYPE_FLAG_RESERVED_ID_BIT;
pub const TYPE_FLOAT = c.G_TYPE_FLOAT;
pub const TYPE_FUNDAMENTAL_MAX = c.G_TYPE_FUNDAMENTAL_MAX;
pub const TYPE_FUNDAMENTAL_SHIFT = c.G_TYPE_FUNDAMENTAL_SHIFT;
pub const TYPE_GSTRING = c.G_TYPE_GSTRING;
pub const TYPE_GTYPE = c.G_TYPE_GTYPE;
pub const TYPE_INT = c.G_TYPE_INT;
pub const TYPE_INT64 = c.G_TYPE_INT64;
pub const TYPE_INTERFACE = c.G_TYPE_INTERFACE;
pub const TYPE_INVALID = c.G_TYPE_INVALID;
pub const TYPE_LONG = c.G_TYPE_LONG;
pub const TYPE_NONE = c.G_TYPE_NONE;
pub const TYPE_OBJECT = c.G_TYPE_OBJECT;
pub const TYPE_PARAM = c.G_TYPE_PARAM;
pub const TYPE_POINTER = c.G_TYPE_POINTER;
pub const TYPE_PYOBJECT = c.G_TYPE_PYOBJECT;
...
pub const TYPE_STRING = c.G_TYPE_STRING;
pub const TYPE_STRV = c.G_TYPE_STRV;
pub const TYPE_UCHAR = c.G_TYPE_UCHAR;
pub const TYPE_UINT = c.G_TYPE_UINT;
pub const TYPE_UINT64 = c.G_TYPE_UINT64;
pub const TYPE_ULONG = c.G_TYPE_ULONG;
pub const TYPE_UNICHAR = c.G_TYPE_UNICHAR;
pub const TYPE_VALUE = c.G_TYPE_VALUE;
pub const TYPE_VARIANT = c.G_TYPE_VARIANT;
