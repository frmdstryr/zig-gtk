...
pub const SignalGroup = extern struct {
    ...
    extern fn g_signal_group_connect_data(self: *Self, detailed_signal: [*c]const u8, c_handler: gobject.Callback, data: ?*anyopaque, notify: gobject.ClosureNotify, flags: gobject.ConnectFlags) void;
    pub const connectData = g_signal_group_connect_data;

    extern fn g_signal_group_connect_swapped(self: *Self, detailed_signal: [*c]const u8, c_handler: gobject.Callback, data: ?*anyopaque) void;
