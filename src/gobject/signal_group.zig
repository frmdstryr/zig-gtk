...
// ObjectInfo(SignalGroup)
const gobject = @import("../gobject.zig");
const glib = @import("glib");
const std = @import("std");
const c = @import("c.zig");

pub const SignalGroup = extern struct {
    const Self = @This();
    ...
    // Constructors
    extern fn g_signal_group_new(target_type: usize) ?*Self;
    ...
    extern fn g_signal_group_dup_target(self: *Self) ?*gobject.Object;
    ...
    pub inline fn connectBind(
        self: *Self,
        comptime T: type,
        callback: *const fn (self: *Self, instance: gobject.Object, data: ?*T) callconv(.C) void,
        data: ?*T,
    ...
    pub inline fn connectBindSwapped(
        self: *Self,
        comptime T: type,
        callback: *const fn (data: *T, instance: gobject.Object) callconv(.C) void,
        data: *T,
        flags: gobject.ConnectFlags
    ) u64 {
    ...
    pub inline fn gType() usize {
        return c.gobject_signal_group_get_type();
    }
};
