...
pub const Binding = extern struct {
    ...
    extern fn g_binding_dup_source(self: *Self) ?*gobject.Object;
    pub const dupSource = g_binding_dup_source;

    extern fn g_binding_dup_target(self: *Self) ?*gobject.Object;
    ...
    extern fn g_binding_get_flags(self: *Self) gobject.BindingFlags;
    ...
    extern fn g_binding_get_source(self: *Self) ?*gobject.Object;
    pub const getSource = g_binding_get_source;

    extern fn g_binding_get_source_property(self: *Self) [*c]const u8;
    pub const getSourceProperty = g_binding_get_source_property;

    extern fn g_binding_get_target(self: *Self) ?*gobject.Object;
    pub const getTarget = g_binding_get_target;

    extern fn g_binding_get_target_property(self: *Self) [*c]const u8;
    ...
    extern fn g_binding_unbind(self: *Self) void;
    ...
    pub inline fn gType() usize {
        return c.gobject_binding_get_type();
    }
};
