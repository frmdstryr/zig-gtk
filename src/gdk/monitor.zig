...
pub const Monitor = extern struct {
    ...
    // Signals
    pub inline fn connectInvalidate(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "invalidate", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectInvalidateSwapped(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "invalidate", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
