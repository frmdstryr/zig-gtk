...
pub const KeyEvent = extern struct {
    ...
    extern fn gdk_key_event_get_consumed_modifiers(self: *Self) gdk.ModifierType;
    ...
    extern fn gdk_key_event_get_keycode(self: *Self) u32;
    pub const getKeycode = gdk_key_event_get_keycode;

    extern fn gdk_key_event_get_keyval(self: *Self) u32;
    pub const getKeyval = gdk_key_event_get_keyval;

    extern fn gdk_key_event_get_layout(self: *Self) u32;
    pub const getLayout = gdk_key_event_get_layout;

    extern fn gdk_key_event_get_level(self: *Self) u32;
    pub const getLevel = gdk_key_event_get_level;

    extern fn gdk_key_event_get_match(self: *Self, keyval: u32, modifiers: gdk.ModifierType) bool;
    ...
    extern fn gdk_key_event_is_modifier(self: *Self) bool;
    pub const isModifier = gdk_key_event_is_modifier;

    extern fn gdk_key_event_matches(self: *Self, keyval: u32, modifiers: gdk.ModifierType) gdk.KeyMatch;
