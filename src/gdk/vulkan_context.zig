...
pub const VulkanContext = extern struct {
    ...
    // Signals
    pub inline fn connectImagesUpdated(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "images-updated", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectImagesUpdatedSwapped(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "images-updated", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
