...
pub const ContentSerializer = extern struct {
    ...
    extern fn gdk_content_serializer_set_task_data(self: *Self, data: ?*anyopaque, notify_: *const fn (data: ?*anyopaque) callconv(.C) void) void;
    ...
    pub inline fn gType() usize {
        return c.gdk_content_serializer_get_type();
    }
};
