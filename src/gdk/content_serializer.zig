...
pub const ContentSerializer = extern struct {
    ...
    extern fn gdk_content_serializer_return_error(self: *Self, error_: *glib.GError) void;
    ...
    extern fn gdk_content_serializer_set_task_data(self: *Self, data: ?*anyopaque, notify: glib.DestroyNotify) void;
