...
pub const DeviceTool = extern struct {
    const Self = @This();
    ...
    extern fn gdk_device_tool_get_axes(self: *Self) gdk.AxisFlags;
    pub const getAxes = gdk_device_tool_get_axes;

    extern fn g_object_get_data(self: *Self, key: [*c]const u8) ?*anyopaque;
    pub const getData = g_object_get_data;

    extern fn gdk_device_tool_get_hardware_id(self: *Self) u64;
    ...
    extern fn gdk_device_tool_get_serial(self: *Self) u64;
    pub const getSerial = gdk_device_tool_get_serial;

    extern fn gdk_device_tool_get_tool_type(self: *Self) gdk.DeviceToolType;
    ...
    pub inline fn gType() usize {
        return c.gdk_device_tool_get_type();
    }
};
