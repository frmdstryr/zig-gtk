...
// ObjectInfo(TouchpadEvent)
const gdk = @import("../gdk.zig");
const std = @import("std");
const c = @import("c.zig");

pub const TouchpadEvent = extern struct {
    const Self = @This();
    ...
    extern fn gdk_touchpad_event_get_deltas(self: *Self, dx: f64, dy: f64) void;
    ...
    extern fn gdk_touchpad_event_get_gesture_phase(self: *Self) gdk.TouchpadGesturePhase;
    ...
    extern fn gdk_touchpad_event_get_n_fingers(self: *Self) u32;
    pub const getNFingers = gdk_touchpad_event_get_n_fingers;

    extern fn gdk_touchpad_event_get_pinch_angle_delta(self: *Self) f64;
    pub const getPinchAngleDelta = gdk_touchpad_event_get_pinch_angle_delta;

    extern fn gdk_touchpad_event_get_pinch_scale(self: *Self) f64;
    ...
    pub inline fn gType() usize {
        return c.gdk_touchpad_event_get_type();
    }
};
