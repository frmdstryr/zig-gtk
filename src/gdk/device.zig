...
pub const Device = extern struct {
    ...
    pub inline fn connectToolChanged(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "tool-changed", @ptrCast(callback), data, null, @intFromEnum(flags));
    }

    pub inline fn connectToolChangedSwapped(
        self: *Self,
        comptime T: type,
        ...
        return c.g_signal_connect_data(self, "tool-changed", @ptrCast(callback), data, null, @as(c.GConnectFlags, @intFromEnum(flags)) | c.G_CONNECT_SWAPPED);
    }
