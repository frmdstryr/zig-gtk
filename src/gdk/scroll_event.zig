...
pub const ScrollEvent = extern struct {
    ...
    extern fn gdk_scroll_event_get_deltas(self: *Self, delta_x: *f64, delta_y: *f64) void;
    ...
    extern fn gdk_scroll_event_get_direction(self: *Self) gdk.ScrollDirection;
    ...
    pub inline fn gType() usize {
        return c.gdk_scroll_event_get_type();
    }
};
